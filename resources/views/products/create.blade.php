        ...
        <div class="flex flex-col lg:flex-row gap-4">
            ...
            <div class="lg:w-2/3">
                <div class="bg-white rounded-lg shadow border">
                    <form method="POST" action="{{ route('products.store') }}" enctype="multipart/form-data" class="p-4">
                        @csrf
                    ...
                    <div class="p-3">
                        <div class="space-y-2">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <i class="fas fa-circle text-gray-300 text-xs" id="status{{ $loop->index }}"></i>
                            </div>
                            @endforeach
                        </div>
                        <div id="validationStatus" class="mt-3 text-center text-xs font-medium text-gray-600">
                            0 dari {{ count($fields) }} terisi
                        </div>
                    </div>
                </div>
            </div>
