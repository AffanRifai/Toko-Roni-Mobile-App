    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <div class="stat-card group">
            ...
            <div class="stat-card-content">
                ...
                <h3 class="text-2xl font-bold text-amber-600">Rp {{ number_format($member->total_piutang, 0, ',', '.') }}</h3>
                <p class="text-xs text-gray-400 mt-1">Dari limit Rp {{ number_format($member->limit_kredit, 0, ',', '.') }}</p>
            </div>
        </div>
                    ...
                    <tr class="hover:bg-white/30 transition-colors">
                        ...
                        <td class="px-6 py-4 text-sm">
                            @if($receivable->jatuh_tempo)
                                ...
                                @endphp
                                <span class="{{ $jatuhTempo < $now && $receivable->status != 'LUNAS' ? 'text-red-600 font-medium' : '' }}">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-2">
                                ...
                                {{-- Tombol Riwayat Pembayaran (ke no_piutang) --}}
                                ...
                                title="Riwayat Pembayaran - {{ $receivable->no_piutang }}">
...
{{-- Modal Bayar Piutang (DARI KODE 2 dengan perbaikan) --}}
<div id="payModal"
