        ...
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 md:gap-6">
            <div class="flex-1">
                <div class="flex items-center gap-3 md:gap-4">
                    ...
                    <div>
                        <h1 class="text-xl md:text-3xl lg:text-4xl font-bold text-gray-800">Selamat datang, <span class="text-blue-600">{{ Auth::user()->name }}!</span> 👋</h1>
        ...
        <div class="bg-white/80 backdrop-blur-sm rounded-2xl overflow-hidden shadow-sm border border-white/50" id="low-stock">
            <div class="p-4 md:p-6 border-b border-gray-100">
                <div class="flex items-center justify-between">
                    ...
                    <a href="{{ route('products.index') }}" class="text-blue-600 hover:text-blue-700 font-medium text-xs md:text-sm flex items-center gap-1">
            ...
            <div class="bg-white/80 backdrop-blur-sm rounded-2xl overflow-hidden shadow-sm border border-white/50">
                <div class="p-4 md:p-6 border-b border-gray-100">
                    <div class="flex flex-col sm:flex-row sm:items-center justify-between">
                        ...
                        <a href="{{ route('transactions.index') }}" class="mt-4 sm:mt-0 px-4 md:px-5 py-2 md:py-2.5 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-xl text-xs md:text-sm font-medium hover:shadow-lg transition-all inline-flex items-center gap-2">
                        ...
                        <div class="p-4 md:p-6 hover:bg-gray-50 transition-colors group">
                            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                                ...
                                <div class="flex items-center justify-between sm:justify-end gap-4">
                                    ...
                                    <a href="{{ route('transactions.show', $transaction) }}" class="w-8 h-8 rounded-lg bg-gray-100 flex items-center justify-center text-gray-600 hover:bg-blue-500 hover:text-white transition-all">
