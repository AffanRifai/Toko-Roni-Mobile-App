...
@section('content')
        ...
        <div class="container mx-auto px-4 py-6 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col lg:flex-row gap-6">
                        ...
                        <div class="bg-white rounded-xl shadow-sm p-5">
                            ...
                            <div class="space-y-3">
                                ...
                                <div class="flex justify-between items-center">
                                    ...
                                    @endphp
                                    <span class="px-3 py-1 rounded-full text-sm font-medium {{ $paymentConfig['bg'] }} {{ $paymentConfig['text'] }} border {{ $paymentConfig['border'] }}">
                                        ...
                                        <tr class="hover:bg-gray-50 transition-colors duration-150">
                                            ...
                                            <td class="py-4 px-4">
                                                <div class="flex items-center">
                                                    ...
                                                    <div>
                                                        <div class="font-semibold text-gray-900">{{ $item->product->name ?? 'Produk tidak ditemukan' }}</div>
                                    ...
                                    <div class="bg-gray-50 rounded-lg p-4 space-y-2">
                                        <div class="flex justify-between">
                                            ...
                                            <span class="font-medium text-gray-900">
                                                {{ $transaction->delivery->recipient_name ?? $transaction->customer_name }}
                                            </span>
                                        </div>
                                        <div class="flex justify-between">
                                            <span class="text-gray-600">Telepon:</span>
                                            <span class="font-medium text-gray-900">
                                                {{ $transaction->delivery->recipient_phone ?? ($transaction->customer_phone ?? '-') }}
                                            </span>
                                        </div>
                                        <div class="flex justify-between">
                                            <span class="text-gray-600">Alamat:</span>
                                            <span class="font-medium text-gray-900 text-right">
                                                {{ $transaction->delivery->destination ?? $transaction->delivery_address ?? '-' }}
                                            </span>
                                        </div>
                                        ...
                                        <div class="flex justify-between">
                                            ...
                                            <span class="font-medium text-gray-900">
                                                {{ \Carbon\Carbon::parse($transaction->desired_delivery_date)->format('d/m/Y') }}
                                            </span>
                                        </div>
                                        @endif
                                    </div>
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div class="bg-gray-50 rounded-lg p-4">
                                        ...
                                        <div class="mb-4">
                                            <div class="flex justify-between items-center pb-2 border-b border-gray-200">
                                                ...
                                                <span class="font-semibold text-blue-600">{{ $totalDikirim }} item</span>
                                            </div>
                                            @if(!empty($itemsToDeliver) && count($itemsToDeliver) > 0)
                                                <div class="mt-2 space-y-1">
                                                    @foreach($itemsToDeliver as $item)
                                                        <div class="flex justify-between text-sm">
                                                            <span class="text-gray-700">{{ $item['name'] ?? 'Produk' }}</span>
                                                            <span class="font-medium text-gray-900">{{ $item['qty'] ?? 0 }} pcs</span>
                                                        </div>
                                                    @endforeach
                                                </div>
                                            @else
                                        ...
                                        <div class="mt-3 pt-2 border-t border-gray-200">
                                            <div class="flex justify-between items-center">
                                                ...
                                                <span class="font-semibold text-green-600">{{ $totalDibawa }} item</span>
                                            </div>
                                            @if($totalDibawa > 0)
                                                <div class="mt-2 space-y-1">
                                                    @foreach($transaction->items as $item)
                                                        ...
                                                        @if(!$isDelivered)
                                                            <div class="flex justify-between text-sm">
                                                                <span class="text-gray-700">{{ $item->product->name ?? 'Produk' }}</span>
                                    ...
                                    <div class="mt-4 space-y-3">
                                        ...
                                        <div class="flex justify-between items-center bg-blue-50 rounded-lg p-3">
                                            ...
                                            <span class="font-bold text-blue-600 text-lg">Rp {{ number_format($transaction->delivery_fee, 0, ',', '.') }}</span>
                                        </div>
                                        @endif
                                ...
                                <div class="bg-gradient-to-br from-white to-gray-50 rounded-lg border border-gray-200 p-6">
                                    ...
                                    @if ($transaction->discount > 0)
                                        <div class="flex justify-between items-center py-2 text-red-600">
                                            ...
                                            <span class="font-medium">
                                                - Rp {{ number_format(($transaction->items->sum('subtotal') * $transaction->discount) / 100, 0, ',', '.') }}
                                            </span>
                                        </div>
                                    @endif
                                    ...
                                    <div class="flex justify-between items-center py-4 border-t border-b border-gray-200 my-2">
                                        ...
                                        <span class="font-bold text-2xl text-blue-600">
                                            Rp {{ number_format($transaction->total_amount + ($transaction->delivery_fee ?? 0), 0, ',', '.') }}
                                        </span>
                                    </div>
                ...
                <div class="lg:w-1/3 space-y-6">
                   ...
                   <!-- ========== FITUR PENGIRIMAN ========== -->
                    @if(auth()->user()->role === 'kasir' || auth()->user()->role === 'owner' || auth()->user()->role === 'manager')
                        @if($transaction->need_delivery && !$transaction->delivery)
                        ...
                        @elseif(!$transaction->need_delivery && !$transaction->delivery)
                            ...
                            <div class="bg-white rounded-xl shadow-sm p-5 border-l-4 border-blue-500">
                                ...
                                <form id="deliveryForm" action="{{ route('delivery.request', $transaction) }}" method="POST" class="space-y-4">
                                    @csrf
                                        ...
                                        <div class="space-y-3">
                                            ...
                                            <label class="flex items-center p-3 border rounded-lg cursor-pointer hover:bg-gray-50 transition-colors">
                                                <input type="radio" name="need_delivery" value="no" class="mr-3" 
                                                    {{ old('need_delivery', 'no') == 'no' ? 'checked' : '' }}
                                    ...
                                    <!-- Delivery Options -->
                                    <div id="deliveryOptions" class="space-y-4 {{ old('need_delivery') == 'yes' ? '' : 'hidden' }}">
                                        <!-- Data Penerima -->
                                        <div class="grid grid-cols-2 gap-3">
                                            <div>
                                                ...
                                                <input type="text" name="recipient_name" id="recipient_name"
                                                    value="{{ old('recipient_name', $transaction->customer_name) }}"
                                            ...
                                            <div>
                                                ...
                                                <input type="text" name="recipient_phone" id="recipient_phone"
                                                    value="{{ old('recipient_phone', $transaction->customer_phone) }}"
                                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <textarea name="delivery_address" id="delivery_address" rows="2"
                                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                                                placeholder="Masukkan alamat lengkap">{{ old('delivery_address', $transaction->customer_address ?? '') }}</textarea>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <input type="date" name="desired_delivery_date" id="desired_delivery_date"
                                                value="{{ old('desired_delivery_date', now()->addDays(2)->format('Y-m-d')) }}"
                                        ...
                                        <div>
                                            ...
                                            <div class="bg-gray-50 rounded-lg p-3 max-h-48 overflow-y-auto">
                                                ...
                                                <label class="flex items-center p-2 hover:bg-white rounded cursor-pointer">
                                                    ...
                                                    <span class="flex-1 text-sm">{{ $item->product->name ?? 'Produk' }}</span>
                                                    <span class="text-sm font-medium text-gray-700">{{ $item->qty }} pcs</span>
                                                </label>
                                                @endforeach
                                            </div>
                                        ...
                                        <div>
                                            ...
                                            <input type="number" name="delivery_fee" id="delivery_fee" 
                                                min="0" step="1000" value="{{ old('delivery_fee', 0) }}"
                                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <textarea name="delivery_notes" id="delivery_notes" rows="2"
                                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                                                placeholder="Catatan tambahan untuk kurir">{{ old('delivery_notes') }}</textarea>
                                        </div>
                                    ...
                                    <div class="space-y-4">
                                                ...
                                                <div>
                                                    ...
                                                    @if($transaction->delivery->status == 'delivered')
                                                        <p class="text-sm text-green-700 mt-2">
                                                            <i class="fas fa-check-circle mr-1"></i>
                                                            Pesanan telah terkirim pada {{ \Carbon\Carbon::parse($transaction->delivery->delivered_at)->format('d/m/Y H:i') }}
                                                        </p>
                                                    @endif
                                                </div>
                                            </div>
                                        ...
                                        <div class="bg-gray-50 rounded-lg p-4 space-y-2">
                                            <div class="flex justify-between text-sm">
                                                ...
                                                <span class="font-medium text-gray-900">{{ $transaction->delivery->delivery_code ?? '-' }}</span>
                                            </div>
                                            <div class="flex justify-between text-sm">
                                                <span class="text-gray-600">Alamat Tujuan:</span>
                                                <span class="font-medium text-gray-900 text-right">{{ $transaction->delivery->destination ?? '-' }}</span>
                                            </div>
                                            @if($transaction->delivery_fee > 0)
                                            <div class="flex justify-between text-sm">
                                                <span class="text-gray-600">Biaya Kirim:</span>
                                                <span class="font-medium text-blue-600">Rp {{ number_format($transaction->delivery_fee, 0, ',', '.') }}</span>
                                            </div>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="space-y-4">
                                        ...
                                        <div class="relative">
                                            ...
                                            <div class="flex items-start mb-6 relative">
                                                ...
                                                <div class="ml-4 flex-1">
                                                    ...
                                                    <p class="text-xs text-gray-500">{{ $transaction->delivery->created_at ? $transaction->delivery->created_at->format('d/m/Y H:i') : '-' }}</p>
                                                </div>
                                            </div>

                                            <!-- Diproses Logistik -->
                                            <div class="flex items-start mb-6 relative">
                                                <div class="w-8 h-8 rounded-full {{ !in_array($transaction->delivery->status, ['pending']) ? 'bg-green-500' : 'bg-gray-300' }} flex items-center justify-center text-white z-10">
                                                    <i class="fas {{ !in_array($transaction->delivery->status, ['pending']) ? 'fa-check' : 'fa-clock' }} text-sm"></i>
                                                </div>
                                                <div class="ml-4 flex-1">
                                                    ...
                                                    @if($transaction->delivery->updated_at && $transaction->delivery->status != 'pending')
                                                        <p class="text-xs text-gray-500">{{ $transaction->delivery->updated_at->format('d/m/Y H:i') }}</p>
                                                    @endif
                                                </div>
                                            </div>
                                            ...
                                            <!-- Ditugaskan ke Kurir -->
                                            <div class="flex items-start mb-6 relative">
                                                <div class="w-8 h-8 rounded-full {{ $transaction->delivery->user_id ? 'bg-green-500' : 'bg-gray-300' }} flex items-center justify-center text-white z-10">
                                                    <i class="fas {{ $transaction->delivery->user_id ? 'fa-check' : 'fa-user' }} text-sm"></i>
                                                </div>
                                                <div class="ml-4 flex-1">
                                                    <h4 class="font-semibold text-gray-900">Ditugaskan ke Kurir</h4>
                                                    @if($transaction->delivery->user)
                                                        <p class="text-sm text-gray-800">{{ $transaction->delivery->user->name ?? 'N/A' }}</p>
                                                        <p class="text-xs text-gray-500">{{ $transaction->delivery->user->phone ?? '-' }}</p>
                                                    @endif
                                                </div>
                                            </div>
                                            ...
                                            <div class="flex items-start mb-6 relative">
                                                <div class="w-8 h-8 rounded-full {{ $transaction->delivery->status == 'delivered' ? 'bg-green-500' : 'bg-orange-500' }} flex items-center justify-center text-white z-10">
                                                    <i class="fas fa-truck text-sm"></i>
                                                </div>
                                                <div class="ml-4 flex-1">
                                                    <h4 class="font-semibold text-gray-900">Dalam Perjalanan</h4>
                                                    @if($transaction->delivery->start_delivery_time)
                                                        <p class="text-xs text-gray-500">{{ \Carbon\Carbon::parse($transaction->delivery->start_delivery_time)->format('d/m/Y H:i') }}</p>
                                                    @endif
                                                </div>
                                            </div>
                                            @endif
                                            ...
                                            <div class="flex items-start relative">
                                                <div class="w-8 h-8 rounded-full {{ $transaction->delivery->status == 'delivered' ? 'bg-green-500' : 'bg-gray-300' }} flex items-center justify-center text-white z-10">
                                                    <i class="fas {{ $transaction->delivery->status == 'delivered' ? 'fa-check' : 'fa-truck' }} text-sm"></i>
                                                </div>
                                                <div class="ml-4 flex-1">
                                                    <h4 class="font-semibold text-gray-900">Terkirim</h4>
                                                    @if($transaction->delivery->delivered_at)
                                                        <p class="text-xs text-gray-500">{{ \Carbon\Carbon::parse($transaction->delivery->delivered_at)->format('d/m/Y H:i') }}</p>
                                                    @endif
                                                    @if($transaction->delivery->recipient_name)
                                                        <p class="text-xs text-gray-600 mt-1">Penerima: {{ $transaction->delivery->recipient_name }}</p>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="bg-gray-50 rounded-lg p-4 space-y-3">
                                            <div class="flex justify-between text-sm">
                                                ...
                                                <span class="font-medium text-gray-900">{{ ucfirst($transaction->delivery->vehicle_type ?? 'motor') }}</span>
                                            </div>
                                            <div class="flex justify-between text-sm">
                                                <span class="text-gray-600">Alamat:</span>
                                                <span class="font-medium text-gray-900 text-right">{{ $transaction->delivery->address ?? ($transaction->delivery->destination ?? '-') }}</span>
                                            </div>
                                            @if($transaction->delivery->notes)
                                            <div class="text-sm">
                                                <span class="text-gray-600">Catatan:</span>
                                                <p class="text-gray-800 mt-1 bg-white p-2 rounded">{{ $transaction->delivery->notes }}</p>
                                            </div>
                                            @endif
                                        </div>
                                    </div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm p-5">
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            ...
                            <div class="bg-gradient-to-br from-white to-cyan-50 border border-cyan-100 rounded-lg p-4 text-center transition-transform duration-300 hover:-translate-y-1">
                                ...
                                <div class="font-bold text-lg text-gray-900">{{ $transaction->created_at->diffForHumans() }}</div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm p-5">
                        ...
                        <div class="bg-gradient-to-br from-white to-gray-50 rounded-lg border border-gray-200 p-4">
                            <div class="flex justify-between items-center py-2 border-b border-gray-100">
                                ...
                                <span class="font-medium text-gray-900">{{ $transaction->created_at->format('d/m/Y') }}</span>
                            </div>
                            <div class="flex justify-between items-center py-2 border-b border-gray-100">
                                <span class="text-gray-600">Jam</span>
                                <span class="font-medium text-gray-900">{{ $transaction->created_at->format('H:i') }}</span>
                            </div>
                            <div class="flex justify-between items-center py-2">
                                <span class="text-gray-600">Lokasi</span>
                                <span class="font-medium text-gray-900">Kasir {{ $transaction->user->name ?? 'N/A' }}</span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <form id="createDeliveryForm" action="{{ route('delivery.request', $transaction) }}" method="POST" class="hidden">
        ...
        <input type="hidden" name="recipient_name" value="{{ $transaction->recipient_name ?? $transaction->customer_name }}">
        <input type="hidden" name="recipient_phone" value="{{ $transaction->recipient_phone ?? $transaction->customer_phone }}">
    ...
    <script>
        ...
        (function() {
            ...
            function handleFormSubmission(form) {
                ...
                if (needDelivery.value === 'no') {
                    window.location.href = "{{ route('transactions.create', $transaction) }}";
                    return false;
                }
