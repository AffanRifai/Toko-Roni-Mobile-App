    ...
    <div class="max-w-md mx-auto">
        <div class="bg-white rounded-3xl shadow-xl shadow-gray-200/50 overflow-hidden border border-gray-100">
            ...
            <div class="relative px-6 pb-6 text-center">
                ...
                <h2 class="text-2xl font-extrabold text-gray-800 tracking-tight">{{ auth()->user()->name }}</h2>
            ...
            <div class="px-6 py-4 space-y-1">
                <div class="group p-3 rounded-xl hover:bg-gray-50 transition-colors">
                    ...
                    <div class="flex items-center mt-1">
                        ...
                        <p class="text-gray-700 font-semibold text-sm">{{ auth()->user()->phone ?: '-' }}</p>
                    </div>
                </div>
                ...
                <div class="group p-3 rounded-xl hover:bg-gray-50 transition-colors">
                    ...
                    <div class="flex items-start mt-1">
                        ...
                        <p class="text-gray-700 font-semibold text-sm leading-relaxed">{{ auth()->user()->address ?: 'Alamat belum diatur' }}</p>
                    </div>
                </div>
                ...
                <div class="group p-3 rounded-xl hover:bg-gray-50 transition-colors">
                    ...
                    <div class="flex items-center mt-1">
                        ...
                        <p class="text-gray-700 font-semibold text-sm">{{ auth()->user()->created_at->translatedFormat('d F Y') }}</p>
                    </div>
                </div>
            </div>
