...
@section('page-subtitle', 'Kelola piutang member')
    ...
    <div class="glass-effect rounded-3xl p-6 md:p-8 shadow-elegant mb-6">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-gray-600 mt-1">Total piutang: Rp {{ number_format($stats['total_piutang']) }}</p>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        <div class="stat-card group">
            ...
            <div class="stat-card-content">
                ...
                <p class="text-xs text-gray-400 mt-1">{{ $stats['jumlah_piutang'] }} transaksi</p>
            </div>
        </div>
        ...
        <div class="stat-card group">
            ...
            <div class="stat-card-content">
                ...
                <h3 class="text-2xl font-bold text-green-600">Rp {{ number_format($stats['total_lunas']) }}</h3>
        ...
        <div class="stat-card group">
            ...
            <div class="stat-card-content">
                ...
                <h3 class="text-2xl font-bold text-red-600">{{ $stats['overdue_count'] }}</h3>
        ...
        <div class="stat-card group">
            ...
            <div class="stat-card-content">
                ...
                <h3 class="text-2xl font-bold text-gray-800">
                    Rp {{ number_format($stats['total_piutang'] / max($stats['jumlah_piutang'], 1)) }}
                </h3>
            </div>
        </div>
    </div>
    ...
    <div class="glass-effect rounded-2xl p-5 mb-6">
        <form method="GET" class="grid grid-cols-1 md:grid-cols-5 gap-4">
            ...
            <div class="flex gap-2">
                ...
                <a href="{{ route('receivables.index') }}" class="px-4 py-3 border border-gray-200 rounded-xl hover:bg-gray-50">
            ...
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-white/30 transition-colors">
                        ...
                        <td class="px-6 py-4">
                            <div class="font-medium">{{ $receivable->member->nama }}</div>
                            <div class="text-xs text-gray-500">{{ $receivable->member->kode_member }}</div>
                        </td>
                        <td class="px-6 py-4">
