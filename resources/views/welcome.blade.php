                        ...
                        <div class="product-card tilt-card">
                            ...
                            <div class="product-info">
                                ...
                                <span class="product-tag">
                                    <iconify-icon icon="{{ $product->category->icon ?? 'ph:package-fill' }}"></iconify-icon> 
    ...
    <section id="angka">
        <div class="angka-grid">
            ...
            <div class="angka-item reveal d1">
                ...
                <div>
                    <div class="angka-number">{{ number_format($stats['members'] > 100 ? $stats['members'] : 5200) }}<span class="angka-plus">+</span></div>
            ...
            <div class="angka-item reveal d2">
                ...
                <div>
                    <div class="angka-number">{{ number_format($stats['products']) }}<span class="angka-plus">+</span></div>
            ...
            <div class="angka-item reveal d3">
                ...
                <div>
                    <div class="angka-number">{{ number_format($stats['categories'] * 3) }}<span class="angka-plus">+</span></div>
