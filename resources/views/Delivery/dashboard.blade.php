...
@section('title', 'Dashboard Logistik Kurir')
...
@section('content')
                ...
                <div
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <h3 class="text-3xl font-bold text-gray-800 mt-2">{{ $stats['total_deliveries'] ?? 0 }}</h3>
                        </div>
                ...
                <div
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <h3 class="text-3xl font-bold text-gray-800 mt-2">{{ $stats['pending_deliveries'] ?? 0 }}</h3>
                        </div>
                ...
                <div
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <h3 class="text-3xl font-bold text-gray-800 mt-2">{{ $stats['delivered_today'] ?? 0 }}</h3>
                        </div>
                ...
                <div
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <h3 class="text-3xl font-bold text-gray-800 mt-2">{{ $stats['active_staff'] ?? 0 }}</h3>
                        </div>
                                ...
                                <a href="{{ route('delivery.index', ['status' => 'pending']) }}"
                                    ...
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm text-gray-600 mt-1">{{ $stats['pending_deliveries'] ?? 0 }}
                                ...
                                <a href="{{ route('delivery.staff.index') }}"
                                    ...
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm text-gray-600 mt-1">{{ $stats['active_staff'] ?? 0 }} kurir aktif
                                            </p>
                                        </div>
                                    </div>
                                        ...
                                        @foreach ($recentDeliveries as $delivery)
                                            <tr class="hover:bg-gray-50 transition-colors duration-150">
                                                <td class="py-4 px-6">
                                                    <div>
                                                        <span
                                                            class="font-semibold text-gray-800">{{ $delivery->delivery_code ?? 'N/A' }}</span>
                                                        <div class="text-xs text-gray-500 mt-1">
                                                            {{ $delivery->created_at->format('H:i') ?? 'N/A' }}
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="py-4 px-6">
                                                    <div class="flex items-center space-x-3">
                                                        ...
                                                        <div>
                                                            <div class="font-medium text-gray-900">
                                                                {{ $delivery->recipient_name ?? 'N/A' }}</div>
                                                            <div class="text-sm text-gray-500">
                                                                {{ $delivery->recipient_phone ?? 'N/A' }}</div>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="py-4 px-6">
                                                    <div class="flex items-center text-gray-600">
                                                        ...
                                                        <span
                                                            class="truncate max-w-[150px]">{{ $delivery->delivery_district ?? 'N/A' }}</span>
                                                    </div>
                                                </td>
                                                <td class="py-4 px-6">
                                                    @php
                        ...
                        <div class="px-6 py-4 border-b border-gray-100">
                            <div class="flex items-center justify-between">
                                ...
                                <span class="bg-cyan-100 text-cyan-800 text-xs font-semibold px-2.5 py-0.5 rounded-full">
                                    {{ $stats['active_staff'] ?? 0 }} Online
                                </span>
                            </div>
                        </div>
                        <div class="p-6 space-y-4">
                            @if(isset($activeStaff) && $activeStaff->count() > 0)
                                        ...
                                        <div class="flex items-center space-x-3">
                                            ...
                                            <div class="relative">
                                                <div
                                                    ...
                                                    {{ substr($staff->name ?? 'K', 0, 1) }}
                                                </div>
                                                @if ($staff->current_lat && $staff->current_lng)
                                                    <div
                                            ...
                                            <div class="flex-1 min-w-0">
                                                <div class="flex justify-between items-start">
                                                    <div>
                                                        <h4 class="font-semibold text-gray-900 truncate">{{ $staff->name ?? 'Kurir' }}
                                                        </h4>
                                                        <div class="flex items-center space-x-3 mt-1">
                                                            <span class="inline-flex items-center text-sm text-gray-600">
                                                                <i class="fas fa-phone text-gray-400 mr-1 text-xs"></i>
                                                                {{ $staff->phone ?? 'Tidak ada telepon' }}
                                                            </span>
                                                            <span class="inline-flex items-center text-sm text-gray-600">
                                                ...
                                                @if ($staff->current_lat && $staff->current_lng)
                                                    <div class="mt-3 flex items-center justify-between">
                                                        ...
                                                        <span class="text-xs text-gray-500">
                                                            {{ $staff->last_location_update ? $staff->last_location_update->diffForHumans() : 'Belum pernah update' }}
                                                        </span>
                                                    </div>
                                                @else
                                                    <div class="mt-3">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const chartData = @json($deliveryChart ?? []);
