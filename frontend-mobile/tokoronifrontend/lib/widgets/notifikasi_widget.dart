...
export '../core/services/notifikasi_service.dart' show NotifItem, NotifikasiService;
...
class _NotifikasiBellState extends State<NotifikasiBell>
  ...
  void _openDropdown() {
    // Refresh data saat buka dropdown
    _loadAll();
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              color: _isOpen ? Colors.white.withOpacity(0.35) : Colors.white24,
...
class _NotifDropdown extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final unread = notifList.where((n) => !n.sudahDibaca).length;
