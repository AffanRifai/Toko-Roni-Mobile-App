// lib/delivery/tambah_kendaraan_page.dart
...
class _TambahKendaraanPageState extends State<TambahKendaraanPage> {
  ...
  void _simpan() {
    ...
    showDialog(
      ...
      builder: (_) => _ConfirmDialog(
        ...
        message:
            '${_namaCtrl.text.trim()} (${_platCtrl.text.trim().toUpperCase()}) akan ditambahkan.',
        confirmLabel: 'Tambah',
        confirmColor: _blue,
        onConfirm: _submitCreate,
      ),
    );
  }
  ...
  Future<void> _submitCreate() async {
    ...
    try {
      final created = await VehicleService.createVehicle(
        ...
        jenisLabel: _jenis,
        statusLabel: _status,
        kapasitasBerat: _toDouble(_beratCtrl.text),
        kapasitasVolume: _toDouble(_volumeCtrl.text),
        tanggalMaintenance: _maintenanceCtrl.text.trim(),
  ...
  void _batal() => showDialog(
    ...
    builder: (_) => _ConfirmDialog(
      ...
      title: 'Batalkan Form?',
      message: 'Data yang diisi akan hilang.',
                ...
                children: [
                  Expanded(
                    child: OutlinedButton.icon(
                      onPressed: _isSubmitting ? null : _batal,
