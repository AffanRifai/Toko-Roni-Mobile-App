// lib/member/edit_member_page.dart
...
class _EditMemberPageState extends State<EditMemberPage> {
  ...
  void initState() {
    ...
    _telCtrl = TextEditingController(text: m.telepon);
    _alamatCtrl = TextEditingController(text: m.alamat);
    _limitCtrl = TextEditingController(text: m.limitKredit.toString());
    _tipe = tipeMemberList.contains(m.tipe) ? m.tipe : null;
    _aktif = m.aktif;
  }
  ...
  bool _validate() {
    ...
    if (_limitCtrl.text.trim().isEmpty) e['limit'] = 'Limit kredit wajib diisi';
  ...
  void _showSimpanDialog() {
    ...
    showDialog(
      ...
      builder: (_) => _ConfirmDialog(
        ...
        iconColor: _blue,
        message:
            'Apakah perubahan data member "${_namaCtrl.text.trim()}" sudah benar?',
  ...
  Future<void> _submitUpdate() async {
    ...
    try {
      final updated = await MemberService.updateMember(
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              _lbl('Alamat'),
              _fld(_alamatCtrl, 'Masukan alamat lengkap', maxLines: 3),
              const SizedBox(height: 16),
