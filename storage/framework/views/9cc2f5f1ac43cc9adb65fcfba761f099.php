    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-5 mb-6">
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div class="flex items-center gap-3">
                ...
                <span class="badge <?php echo e($delivery->getStatusBadgeClass()); ?> text-sm px-3 py-1.5">
                    <i class="fas <?php echo e($delivery->getStatusIcon()); ?> mr-2"></i>
                ...
                <div class="p-5">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <p class="font-semibold text-gray-900"><?php echo e($delivery->transaction->created_at->format('d/m/Y H:i')); ?></p>
                        </div>
                        <div>
                            <p class="text-sm text-gray-600">Customer</p>
                            <p class="font-semibold text-gray-900"><?php echo e($delivery->transaction->customer_name); ?></p>
                        </div>
                        <div>
                            <p class="text-sm text-gray-600">Total Belanja</p>
                            <p class="font-semibold text-green-600">Rp <?php echo e(number_format($delivery->transaction->total_amount, 0, ',', '.')); ?></p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="relative">
                        ...
                        <div class="flex items-start mb-6 relative">
                            ...
                            <div class="ml-4 flex-1">
                                ...
                                <p class="text-sm text-gray-600"><?php echo e($delivery->created_at->format('d/m/Y H:i')); ?></p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start mb-6 relative">
                            ...
                            <div class="ml-4 flex-1">
                                ...
                                <?php if(!in_array($delivery->status, ['pending'])): ?>
                                    <p class="text-sm text-gray-600"><?php echo e($delivery->updated_at->format('d/m/Y H:i')); ?></p>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <!-- Ditugaskan ke Kurir -->
                        <div class="flex items-start mb-6 relative">
                            <div class="w-8 h-8 rounded-full <?php echo e($delivery->driver_id ? 'bg-green-500' : 'bg-gray-300'); ?> flex items-center justify-center text-white z-10">
                                <i class="fas <?php echo e($delivery->driver_id ? 'fa-check' : 'fa-user'); ?> text-sm"></i>
                            </div>
                            <div class="ml-4 flex-1">
                                <h4 class="font-semibold text-gray-900">Ditugaskan ke Kurir</h4>
                                <?php if($delivery->driver): ?>
                                    <p class="text-sm font-medium text-gray-900"><?php echo e($delivery->driver->name); ?></p>
                                    <p class="text-xs text-gray-500"><?php echo e($delivery->driver->phone ?? '-'); ?></p>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start mb-6 relative">
                            ...
                            <div class="ml-4 flex-1">
                                ...
                                <?php if($delivery->pickup_time): ?>
                                    <p class="text-sm text-gray-600"><?php echo e($delivery->pickup_time->format('d/m/Y H:i')); ?></p>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start mb-6 relative">
                            ...
                            <div class="ml-4 flex-1">
                                ...
                                <?php if($delivery->start_delivery_time): ?>
                                    <p class="text-sm text-gray-600"><?php echo e($delivery->start_delivery_time->format('d/m/Y H:i')); ?></p>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start relative">
                            ...
                            <div class="ml-4 flex-1">
                                ...
                                <?php if($delivery->delivered_at): ?>
                                    <p class="text-sm text-gray-600"><?php echo e($delivery->delivered_at->format('d/m/Y H:i')); ?></p>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
                ...
                <div class="p-5">
                    <div class="space-y-3">
                        <div>
                            ...
                            <p class="font-medium text-gray-900 bg-gray-50 p-2 rounded"><?php echo e($delivery->origin); ?></p>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <p class="font-medium text-gray-900"><?php echo e($delivery->estimated_delivery_time->format('d/m/Y H:i')); ?></p>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="p-5">
                    <div class="space-y-3">
                        ...
                        <div class="flex justify-between">
                            ...
                            <span class="font-medium text-gray-900"><?php echo e($delivery->total_weight); ?> kg</span>
                        </div>
                        <?php endif; ?>
                        <?php if($delivery->total_volume > 0): ?>
                        <div class="flex justify-between">
                            <span class="text-gray-600">Total Volume</span>
                            <span class="font-medium text-gray-900"><?php echo e($delivery->total_volume); ?> m³</span>
                        </div>
                        <?php endif; ?>
                ...
                <div>
                    ...
                    <select name="vehicle_id" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                        ...
                        <?php $__currentLoopData = $availableVehicles ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vehicle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($vehicle->id); ?>"><?php echo e($vehicle->name); ?> - <?php echo e($vehicle->plate_number); ?> (<?php echo e($vehicle->type); ?>)</option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT3\Toko-Roni-Mobile-App\tokoroni-app\resources\views\Delivery\show.blade.php ENDPATH**/ ?>