<?php $__env->startSection('title', 'Dashboard Checker Barang'); ?>
<?php $__env->startSection('page-title', 'Dashboard Checker Barang'); ?>
<?php $__env->startSection('page-subtitle', 'Pantau stok dan kualitas produk'); ?>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6 mb-6 md:mb-8">
        ...
        <div class="bg-white/80 backdrop-blur-sm rounded-2xl p-5 md:p-6 shadow-sm border border-white/50 hover:shadow-md transition-all">
            <div class="flex items-center justify-between">
                ...
                <a href="<?php echo e(route('products.index')); ?>?filter=low_stock" class="w-8 h-8 rounded-lg bg-gray-100 flex items-center justify-center text-gray-600 hover:bg-amber-500 hover:text-white transition-all">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3 md:gap-4">
                    ...
                    <div>
                        ...
                        <h3 class="text-xl md:text-3xl font-bold text-gray-800 mt-1"><?php echo e(number_format($expiringSoonCount ?? 0)); ?></h3>
                    </div>
                </div>
                <a href="<?php echo e(route('products.index')); ?>?expiry=expiring" class="w-8 h-8 rounded-lg bg-gray-100 flex items-center justify-center text-gray-600 hover:bg-yellow-500 hover:text-white transition-all">
                    <i class="fas fa-arrow-right text-xs"></i>
                </a>
            </div>
            <div class="flex items-center justify-between mt-4 pt-3 border-t border-gray-100">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3 md:gap-4">
                    ...
                    <div>
                        ...
                        <h3 class="text-xl md:text-3xl font-bold text-gray-800 mt-1"><?php echo e(number_format($expiredCount ?? 0)); ?></h3>
                    </div>
                </div>
                <a href="<?php echo e(route('products.index')); ?>?expiry=expired" class="w-8 h-8 rounded-lg bg-gray-100 flex items-center justify-center text-gray-600 hover:bg-red-500 hover:text-white transition-all">
                    <i class="fas fa-arrow-right text-xs"></i>
                </a>
            </div>
            <div class="flex items-center justify-between mt-4 pt-3 border-t border-gray-100">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3 md:gap-4">
                    ...
                    <div>
                        ...
                        <h3 class="text-xl md:text-3xl font-bold text-gray-800 mt-1"><?php echo e(number_format($activeProducts ?? 0)); ?></h3>
                    </div>
                </div>
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3 md:gap-4">
                    ...
                    <div>
                        ...
                        <h3 class="text-xl md:text-3xl font-bold text-gray-800 mt-1"><?php echo e(number_format($totalCategories ?? 0)); ?></h3>
                    </div>
                </div>
                <div class="w-8 h-8 rounded-lg bg-gray-100 flex items-center justify-center text-gray-400">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3 md:gap-4">
                    ...
                    <div>
                        ...
                        ?>
                        <h3 class="text-xl md:text-3xl font-bold text-gray-800 mt-1"><?php echo e($ratio); ?>%</h3>
                    </div>
                </div>
                <div class="w-8 h-8 rounded-lg bg-gray-100 flex items-center justify-center text-gray-400">
        ...
        <div class="glass-effect rounded-3xl overflow-hidden shadow-elegant">
            <div class="p-4 md:p-6 border-b border-gray-100/50">
                <div class="flex items-center justify-between">
                    ...
                    <a href="<?php echo e(route('products.index')); ?>?filter=low_stock" class="text-indigo-600 hover:text-indigo-700 text-sm font-medium">
                        Lihat Semua
                    </a>
                </div>
            </div>
                        ...
                        <div class="flex-1 min-w-0">
                            <div class="flex items-start justify-between gap-2">
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500 mt-1"><?php echo e($product->category->name ?? '-'); ?></p>
                                </div>
                            ...
                            <div class="flex items-center justify-between mt-3">
                                <div class="flex-1 mr-3">
                                    <div class="w-full bg-gray-200 rounded-full h-2.5">
                                        <div class="h-2.5 rounded-full bg-amber-500" style="width: <?php echo e(min(100, $product->stock_percentage ?? 0)); ?>%"></div>
                                    </div>
                                </div>
                                <button onclick="showReportModal(<?php echo e($product->id); ?>, '<?php echo e($product->name); ?>', 'low_stock')"
        ...
        <div class="glass-effect rounded-3xl overflow-hidden shadow-elegant">
            <div class="p-4 md:p-6 border-b border-gray-100/50">
                <div class="flex items-center justify-between">
                    ...
                    <a href="<?php echo e(route('products.index')); ?>?expiry=expiring" class="text-indigo-600 hover:text-indigo-700 text-sm font-medium">
                        Lihat Semua
                    </a>
                </div>
            </div>
                        ...
                        <div class="flex items-start gap-3">
                            <div class="relative flex-shrink-0">
                                <div class="w-12 h-12 rounded-xl bg-gradient-to-br from-yellow-100 to-amber-100 flex items-center justify-center">
                                    <i class="fas <?php echo e($product->status_icon ?? 'fa-clock'); ?> text-yellow-600"></i>
                                </div>
                            </div>
                            <div class="flex-1 min-w-0">
                                <div class="flex items-start justify-between gap-2">
                                    ...
                                    <div class="text-right">
                                        <span class="inline-block px-2 py-1 rounded-lg text-xs font-medium 
                                            <?php echo e($product->status_class ?? 'bg-yellow-100 text-yellow-800'); ?>">
                                            <i class="<?php echo e($product->status_icon ?? 'fa-clock'); ?> mr-1"></i>
                                            <?php echo e($product->days_display ?? ($product->days_left . ' hari lagi')); ?>
                                ...
                                <div class="flex items-center justify-between mt-3">
                                    <p class="text-xs text-gray-500">
                                        ...
                                        <?php echo e($product->expiry_date ? \Carbon\Carbon::parse($product->expiry_date)->format('d M Y') : '-'); ?>

                                    </p>
                                    <button onclick="showReportModal(<?php echo e($product->id); ?>, '<?php echo e($product->name); ?>', 'expiring')"
                                            class="px-3 py-1.5 bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-medium rounded-lg transition-colors">
                                        <i class="fas fa-flag mr-1"></i> Laporkan
                                    </button>
                                </div>
                                ...
                                <div class="mt-3">
                                    <div class="flex items-center justify-between text-xs text-gray-500 mb-1">
                                        ...
                                        <span><?php echo e($product->days_left); ?> dari 30 hari</span>
                                    </div>
                                    <div class="w-full bg-gray-200 rounded-full h-1.5">
                                        ...
                                        <div class="h-1.5 rounded-full 
                                            <?php echo e($product->days_left <= 3 ? 'bg-red-500' : ($product->days_left <= 7 ? 'bg-orange-500' : 'bg-yellow-500')); ?>" 
        ...
        <div class="glass-effect rounded-3xl overflow-hidden shadow-elegant">
            <div class="p-4 md:p-6 border-b border-gray-100/50">
                <div class="flex items-center justify-between">
                    ...
                    <a href="<?php echo e(route('products.index')); ?>?expiry=expired" class="text-indigo-600 hover:text-indigo-700 text-sm font-medium">
                        Lihat Semua
                    </a>
                </div>
            </div>
                            ...
                            <div class="flex items-start justify-between gap-2">
                                ...
                                <div class="text-right">
                                    <span class="inline-block px-2 py-1 rounded-lg text-xs font-medium bg-red-100 text-red-800">
                                        <?php echo e($product->days_expired ?? 0); ?> hari expired
                                    </span>
                                </div>
                            </div>
                            <div class="flex items-center justify-between mt-3">
                                <p class="text-xs text-gray-500">Stok: <?php echo e($product->stock); ?></p>
                                <button onclick="showReportModal(<?php echo e($product->id); ?>, '<?php echo e($product->name); ?>', 'expired')"
        ...
        <div class="glass-effect rounded-3xl overflow-hidden shadow-elegant">
            <div class="p-4 md:p-6 border-b border-gray-100/50">
                <div class="flex items-center justify-between">
                    ...
                    <a href="<?php echo e(route('checker.index')); ?>" class="text-indigo-600 hover:text-indigo-700 text-sm font-medium">
                        Lihat Semua
                    </a>
                </div>
            </div>
                    ...
                    <div class="flex items-start gap-3">
                        <div class="flex-shrink-0">
                            <div class="w-10 h-10 rounded-xl 
                                <?php echo e($report->status == 'pending' ? 'bg-yellow-100' : ($report->status == 'resolved' ? 'bg-green-100' : 'bg-blue-100')); ?> 
                                flex items-center justify-center">
                                <i class="fas 
                                    <?php echo e($report->status == 'pending' ? 'fa-clock text-yellow-600' : 
                        ...
                        <div class="flex-1 min-w-0">
                            <div class="flex items-start justify-between gap-2">
                                <div>
                                    <h4 class="font-medium text-gray-900 truncate"><?php echo e($report->product->name ?? 'Produk'); ?></h4>
                                    <p class="text-xs text-gray-500 mt-1">
                                        <?php if($report->report_type == 'low_stock'): ?>
                                            Stok Rendah
                                        <?php elseif($report->report_type == 'expiring'): ?>
                                            Akan Kadaluarsa
                                        <?php elseif($report->report_type == 'expired'): ?>
                                            Kadaluarsa
                                        <?php else: ?>
                                            <?php echo e($report->report_type); ?>
                            ...
                            <p class="text-xs text-gray-600 mt-2 line-clamp-2"><?php echo e($report->notes); ?></p>
                            <p class="text-xs text-gray-400 mt-2"><?php echo e($report->created_at->diffForHumans()); ?></p>
                        </div>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laravel project 3\Toko-Roni-Mobile-App\resources\views/dashboard/checker.blade.php ENDPATH**/ ?>