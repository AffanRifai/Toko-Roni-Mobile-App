    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-6 md:mb-8">
                ...
                <div class="flex items-center justify-between mb-4">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <h3 class="text-xl md:text-2xl font-bold text-gray-800 mt-1"><?php echo e($todayTransactions ?? 0); ?></h3>
                        </div>
                    </div>
                </div>
        ...
        <div class="stat-card group">
            ...
            <div class="stat-card-content">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center text-xs">
                        <span class="text-gray-500"><?php echo e($topProductToday ?? 'Produk terlaris'); ?></span>
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500 mt-1">
                                        ...
                                        <?php echo e($transaction->items->count()); ?> items
                                    </p>
                                </div>
                            </div>
                            <div class="text-right">
                                ...
                                <span class="inline-block mt-1 px-2 py-1 rounded-full text-xs font-medium
                                    <?php echo e($transaction->status === 'completed' ? 'bg-emerald-100 text-emerald-800' : 'bg-amber-100 text-amber-800'); ?>">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT3\Toko-Roni-Mobile-App\tokoroni-app\resources\views\dashboard\kasir.blade.php ENDPATH**/ ?>