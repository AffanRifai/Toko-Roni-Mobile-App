...
<body>
    ...
    <div class="info">
        <div class="info-row">
            ...
            <span class="info-value"><strong><?php echo e($periodeText); ?></strong></span>
        </div>
        <div class="info-row">
    ...
    <table class="stats-table">
        <tr>
            <td>
                ...
                <div class="stats-value"><?php echo e($stats['total']); ?></div>
            </td>
            <td>
                <div class="stats-label">PENDING</div>
                <div class="stats-value"><?php echo e($stats['pending']); ?></div>
            </td>
        </tr>
        <tr>
            <td>
                <div class="stats-label">PROCESSING</div>
                <div class="stats-value"><?php echo e($stats['processing']); ?></div>
            </td>
            <td>
                <div class="stats-label">ASSIGNED</div>
                <div class="stats-value"><?php echo e($stats['assigned']); ?></div>
            </td>
        </tr>
        <tr>
            <td>
                <div class="stats-label">PICKED UP</div>
                <div class="stats-value"><?php echo e($stats['picked_up']); ?></div>
            </td>
            <td>
                <div class="stats-label">ON DELIVERY</div>
                <div class="stats-value"><?php echo e($stats['on_delivery']); ?></div>
            </td>
        </tr>
        <tr>
            <td>
                <div class="stats-label">TERKIRIM</div>
                <div class="stats-value"><?php echo e($stats['delivered']); ?></div>
            </td>
            <td>
                <div class="stats-label">GAGAL</div>
                <div class="stats-value"><?php echo e($stats['failed']); ?></div>
            </td>
        </tr>
        <tr>
            <td>
                <div class="stats-label">DIBATALKAN</div>
                <div class="stats-value"><?php echo e($stats['cancelled']); ?></div>
            </td>
            <td></td>
        </tr>
    </table>
    ...
    <div class="total-info">
        <span> Total Item: <?php echo e($deliveries->sum('total_items')); ?> item</span>
        <span> Total Pengiriman: <?php echo e($stats['total']); ?> pengiriman</span>
    </div>
            ...
            <?php $__empty_1 = true; $__currentLoopData = $deliveries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $delivery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    ...
                    <td class="text-center">
                        <span class="code"><?php echo e($delivery->delivery_code); ?></span>
                    </td>
                    <td class="text-center"><?php echo e($delivery->transaction->invoice_number ?? '-'); ?></td>
                    <td><?php echo e(Str::limit($delivery->destination ?? '-', 30)); ?></td>
                    <td>
                        <?php if($delivery->user): ?>
                            <div class="driver-info">
                                <div class="driver-avatar">
                                    <?php echo e(substr($delivery->user->name, 0, 1)); ?>

                                </div>
                                <span class="driver-name"><?php echo e($delivery->user->name); ?></span>
                            </div>
                        <?php else: ?>
                            <span class="badge badge-pending">Belum Assign</span>
                        <?php endif; ?>
                    </td>
                    <td class="text-center"><?php echo e($delivery->vehicle->name ?? '-'); ?></td>
                    <td class="text-center">
                        <?php
                    ...
                    <td class="text-center"><?php echo e(\Carbon\Carbon::parse($delivery->created_at)->format('d/m/Y')); ?></td>
                    <td class="text-center">
                        <?php echo e($delivery->estimated_delivery_time ? \Carbon\Carbon::parse($delivery->estimated_delivery_time)->format('d/m/Y') : '-'); ?>
    ...
    <!-- FOOTER -->
    <div class="footer">
        Dicetak pada: <?php echo e($generatedAt); ?>

    </div>

</body>
</html><?php /**PATH D:\PROJECT3\Toko-Roni-Mobile-App\tokoroni-app\resources\views\Delivery\reports\delivery-pdf.blade.php ENDPATH**/ ?>