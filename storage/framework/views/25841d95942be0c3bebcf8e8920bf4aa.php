<?php $__env->startSection('title', 'Laporan Sistem'); ?>
...
<div class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50 p-4 md:p-6">
    <div class="max-w-7xl mx-auto">
                ...
                <div class="bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-xl p-5 shadow-lg">
                    <div class="flex justify-between items-start">
                        <div>
                            ...
                            <h3 class="text-2xl font-bold">Rp <?php echo e(number_format($totalRevenue ?? 0, 0, ',', '.')); ?></h3>
                        </div>
                    ...
                    <div class="mt-4 pt-3 border-t border-blue-500/30">
                        <div class="flex items-center justify-between">
                            ...
                            <span class="font-medium"><?php echo e($transactionCount ?? 0); ?></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl p-5 shadow border border-gray-200">
                    <div class="flex justify-between items-start">
                        <div>
                            ...
                            <h3 class="text-2xl font-bold text-gray-900"><?php echo e($productCount ?? 0); ?></h3>
                        </div>
                    ...
                    <div class="mt-4 pt-3 border-t border-gray-100">
                        <div class="flex items-center justify-between">
                            ...
                            <span class="font-medium text-orange-600"><?php echo e($lowStockCount ?? 0); ?></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl p-5 shadow border border-gray-200">
                    <div class="flex justify-between items-start">
                        <div>
                            ...
                            <h3 class="text-2xl font-bold text-gray-900">Rp <?php echo e(number_format($averageTransaction ?? 0, 0, ',', '.')); ?></h3>
                        </div>
                ...
                <div class="bg-white rounded-xl p-5 shadow border border-gray-200">
                    <div class="flex justify-between items-start">
                        <div>
                            ...
                            <h3 class="text-2xl font-bold text-gray-900"><?php echo e($customerCount ?? 0); ?></h3>
                        </div>
                    ...
                    <div class="mt-4 pt-3 border-t border-gray-100">
                        <div class="flex items-center justify-between">
                            ...
                            <span class="font-medium text-blue-600"><?php echo e($todayCustomers ?? 0); ?></span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white rounded-xl shadow border border-gray-200 mb-6 overflow-hidden">
            ...
            <div class="p-6">
                <form method="GET" action="<?php echo e(route('reports.index')); ?>" class="space-y-4">
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                        <div>
                    ...
                    <div class="flex flex-wrap gap-3 pt-2">
                        ...
                        <a href="<?php echo e(route('reports.index')); ?>" class="px-5 py-2.5 bg-white border border-gray-300 text-gray-700 font-medium rounded-lg hover:bg-gray-50 transition-colors flex items-center gap-2">
            ...
            <div class="bg-white rounded-xl shadow border border-gray-200 overflow-hidden mb-6">
                <div class="border-b border-gray-200 px-6 py-4">
                    <div class="flex items-center justify-between">
                        ...
                        <form action="<?php echo e(route('reports.export.pdf')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
            ...
            <div class="bg-white rounded-xl shadow border border-gray-200 overflow-hidden mb-6">
                <div class="border-b border-gray-200 px-6 py-4">
                    <div class="flex items-center justify-between">
                        ...
                        <a href="<?php echo e(route('reports.best-selling')); ?>"
                    ...
                    <table class="w-full">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                    <?php echo e($product->sold_count ?? 0); ?>

                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-semibold text-blue-600">
                                    Rp <?php echo e(number_format($product->revenue ?? 0, 0, ',', '.')); ?>
                    ...
                    <div class="space-y-4">
                        <div>
                            <div class="flex justify-between mb-1">
                                ...
                                <span class="text-sm font-medium text-green-600"><?php echo e($inStockCount ?? 0); ?></span>
                            </div>
                            <div class="w-full bg-gray-200 rounded-full h-2">
                                <div class="bg-green-600 h-2 rounded-full" style="width: <?php echo e(($inStockCount/$productCount)*100); ?>%"></div>
                            </div>
                        </div>
                        ...
                        <div>
                            <div class="flex justify-between mb-1">
                                ...
                                <span class="text-sm font-medium text-orange-600"><?php echo e($lowStockCount ?? 0); ?></span>
                            </div>
                            <div class="w-full bg-gray-200 rounded-full h-2">
                                <div class="bg-orange-500 h-2 rounded-full" style="width: <?php echo e(($lowStockCount/$productCount)*100); ?>%"></div>
                            </div>
                        </div>
                        ...
                        <div>
                            <div class="flex justify-between mb-1">
                                ...
                                <span class="text-sm font-medium text-red-600"><?php echo e($outOfStockCount ?? 0); ?></span>
                            </div>
                            <div class="w-full bg-gray-200 rounded-full h-2">
                                <div class="bg-red-600 h-2 rounded-full" style="width: <?php echo e(($outOfStockCount/$productCount)*100); ?>%"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-8 pt-6 border-t border-gray-200">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex justify-between items-center">
                                ...
                                <span class="text-sm font-medium text-gray-900"><?php echo e($category->products_count ?? 0); ?></span>
                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT3\Toko-Roni-Mobile-App\tokoroni-app\resources\views\reports\index.blade.php ENDPATH**/ ?>