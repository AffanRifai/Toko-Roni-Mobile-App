...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-8">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
            ...
            <!-- Form Content -->
            <form action="<?php echo e(route('categories.store')); ?>" method="POST" class="p-6 sm:p-8">
                <?php echo csrf_field(); ?>
                ...
                <div class="mb-8 bg-blue-50 border border-blue-100 rounded-xl p-4">
                    ...
                    <div class="flex items-center bg-white rounded-lg border border-gray-200 p-3">
                        ...
                        <span id="slugPreview" class="font-mono text-blue-600 bg-blue-50 px-2 py-1 rounded">
                            <?php echo e(old('name') ? Str::slug(old('name')) : 'nama-kategori'); ?>
                ...
                <div class="mb-8">
                    ...
                    <div class="relative">
                        ...
                        <textarea name="description"
                                  ...
                                  oninput="updateDescCharCount(this.value)"><?php echo e(old('description')); ?></textarea>
                        ...
                        <label class="inline-flex items-center cursor-pointer">
                            ...
                            <div class="ml-4 flex items-center">
                                <span class="text-lg font-medium text-gray-900 mr-2" id="statusText">
                                    <?php echo e(old('is_active', true) ? 'Aktif' : 'Nonaktif'); ?>

                                </span>
                                <span id="statusBadge" class="px-3 py-1 rounded-full text-sm font-medium <?php echo e(old('is_active', true) ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
                                    <i class="fas <?php echo e(old('is_active', true) ? 'fa-check-circle' : 'fa-times-circle'); ?> mr-1"></i>
                                    <?php echo e(old('is_active', true) ? 'Aktif' : 'Nonaktif'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT3\Toko-Roni-Mobile-App\tokoroni-app\resources\views/categories/create.blade.php ENDPATH**/ ?>