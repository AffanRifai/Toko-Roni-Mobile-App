        ...
        <aside id="sidebar" class="flex flex-col bg-white dark:bg-gray-800 shadow-xl">
            ...
            <div class="flex-1 overflow-y-auto scrollbar-thin py-4 px-3">
                <nav class="space-y-1">
                    ...
                    <?php if(in_array(Auth::user()->role, ['kasir', 'owner'])): ?>
                        <!-- Transaction Section -->
                        <div class="sidebar-hide pt-3 mt-2 border-t border-gray-100 dark:border-gray-700">
                            <div class="px-3 mb-1">
                    ...
                    <?php if(in_array(Auth::user()->role, ['owner', 'gudang'])): ?>
                        <!-- Inventory Section -->
                        <div class="sidebar-hide pt-3 mt-2 border-t border-gray-100 dark:border-gray-700">
                            <div class="px-3 mb-1">
...
<?php /**PATH D:\PROJECT3\Toko-Roni-Mobile-App\tokoroni-app\resources\views/layouts/app.blade.php ENDPATH**/ ?>