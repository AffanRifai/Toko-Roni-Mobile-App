<?php $__env->startSection('title', 'AI Sales Forecasting'); ?>
...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 bg-white rounded-xl shadow-md p-6 border border-gray-100">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <?php $__currentLoopData = $demandForecast; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="p-4 rounded-lg border <?php echo e($item['stock_status'] == 'danger' ? 'bg-red-50 border-red-100' : 'bg-green-50 border-green-100'); ?>">
                    <div class="flex justify-between items-start mb-2">
                        <div>
                            <h3 class="font-bold text-gray-800"><?php echo e($item['name']); ?></h3>
                            <span class="text-xs text-gray-500"><?php echo e($item['code']); ?></span>
                        </div>
                        <span class="px-2 py-1 rounded text-[10px] font-bold uppercase <?php echo e($item['stock_status'] == 'danger' ? 'bg-red-200 text-red-800' : 'bg-green-200 text-green-800'); ?>">
                            <?php echo e($item['recommendation']); ?>

                        </span>
                    </div>
                    <div class="flex justify-between text-xs">
                        <span class="text-gray-600">Stok: <strong><?php echo e($item['current_stock']); ?></strong></span>
                        <span class="text-gray-600">Butuh: <strong><?php echo e($item['projected_demand']); ?></strong></span>
                    </div>
                </div>
    ...
    <div class="mt-8 grid grid-cols-1 md:grid-cols-4 gap-4">
        <?php $__currentLoopData = $salesForecast; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php if($index < 4): ?>
        <div class="bg-indigo-600 rounded-xl p-6 text-white shadow-lg transform hover:scale-105 transition duration-300">
            <span class="text-indigo-200 text-xs font-bold uppercase"><?php echo e($day['label']); ?></span>
            <div class="mt-2 text-2xl font-black">Rp <?php echo e(number_format($day['value'], 0, ',', '.')); ?></div>
            <div class="mt-4 flex items-center text-xs">
                <span class="bg-indigo-500 bg-opacity-50 px-2 py-1 rounded-full mr-2">Confidence: <?php echo e($day['confidence']); ?>%</span>
            </div>
        </div>
        <?php endif; ?>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT3\Toko-Roni-Mobile-App\tokoroni-app\resources\views/forecast/index.blade.php ENDPATH**/ ?>