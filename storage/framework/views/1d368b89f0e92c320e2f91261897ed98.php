    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <div class="stat-card group">
            ...
            <div class="stat-card-content">
                ...
                <p class="text-xs text-gray-400 mt-1"><?php echo e($stats['total'] > 0 ? round(($stats['active']/$stats['total'])*100) : 0); ?>% dari total</p>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Toko-Roni-Mobile-App\resources\views/members/index.blade.php ENDPATH**/ ?>