        ...
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 md:gap-6">
            <div class="flex-1">
                <div class="flex items-center gap-3 md:gap-4">
                    ...
                    <div>
                        <h1 class="text-xl md:text-3xl lg:text-4xl font-bold text-gray-800">Selamat datang, <span class="text-purple-600"><?php echo e(Auth::user()->name); ?>!</span> 👋</h1>
        ...
        <div class="bg-white/80 backdrop-blur-sm rounded-2xl overflow-hidden shadow-sm border border-white/50" id="low-stock">
            <div class="p-4 md:p-6 border-b border-gray-100">
                <div class="flex items-center justify-between">
                    ...
                    <a href="<?php echo e(route('products.index')); ?>" class="text-purple-600 hover:text-purple-700 font-medium text-xs md:text-sm flex items-center gap-1">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center justify-between mb-4 md:mb-6">
                    ...
                    <div class="flex flex-wrap items-center gap-3 mt-4 sm:mt-0">
                        ...
                        <select id="chartRange" class="px-3 md:px-4 py-1.5 md:py-2 bg-white border border-gray-200 rounded-xl text-xs md:text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500">
                            <option value="7" <?php echo e($chartRange == 7 ? 'selected' : ''); ?>>7 Hari</option>
                            <option value="30" <?php echo e($chartRange == 30 ? 'selected' : ''); ?>>30 Hari</option>
                            <option value="90" <?php echo e($chartRange == 90 ? 'selected' : ''); ?>>90 Hari</option>
                            <option value="180" <?php echo e($chartRange == 180 ? 'selected' : ''); ?>>180 Hari</option>
                            <option value="360" <?php echo e($chartRange == 360 ? 'selected' : ''); ?>>360 Hari</option>
                        </select>
                    </div>
                </div>
            ...
            <div class="bg-white/80 backdrop-blur-sm rounded-2xl overflow-hidden shadow-sm border border-white/50">
                <div class="p-4 md:p-6 border-b border-gray-100">
                    <div class="flex flex-col sm:flex-row sm:items-center justify-between">
                        ...
                        <a href="<?php echo e(route('transactions.index')); ?>" class="mt-4 sm:mt-0 px-4 md:px-5 py-2 md:py-2.5 bg-gradient-to-r from-purple-500 to-purple-600 text-white rounded-xl text-xs md:text-sm font-medium hover:shadow-lg transition-all inline-flex items-center gap-2">
                        ...
                        <div class="p-4 md:p-6 hover:bg-gray-50 transition-colors group">
                            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                                ...
                                <div class="flex items-center justify-between sm:justify-end gap-4">
                                    ...
                                    <a href="<?php echo e(route('transactions.show', $transaction)); ?>" class="w-8 h-8 rounded-lg bg-gray-100 flex items-center justify-center text-gray-600 hover:bg-purple-500 hover:text-white transition-all">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Toko-Roni-Mobile-App\resources\views/dashboard/manager.blade.php ENDPATH**/ ?>