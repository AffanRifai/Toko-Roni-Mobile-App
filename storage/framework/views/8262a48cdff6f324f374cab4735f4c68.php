...
<?php echo app('Illuminate\Foundation\Vite')(['resources/css/tambahuser.css']); ?>
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css">
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.10.3/font/bootstrap-icons.css">
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/css/bootstrap.min.css">
<link rel="stylesheet" href="<?php echo e(asset('css/tambahuser.css')); ?>">
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="card border-0 shadow-sm">
                        ...
                        <form method="POST" action="<?php echo e(route('users.store')); ?>" id="user-form">
                            <?php echo csrf_field(); ?>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="password" name="password_confirmation"
                                                ...
                                                class="form-control border-start-0 <?php $__errorArgs = ['password_confirmation'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select name="jenis_toko" id="store_type"
                                                class="form-select border-start-0 <?php $__errorArgs = ['jenis_toko'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                ...
                                                <option value="grosir"
                                                    <?php echo e(old('jenis_toko') == 'grosir' ? 'selected' : ''); ?>>
                                                    Toko Grosir
                                                </option>
                                                <option value="eceran"
                                                    <?php echo e(old('jenis_toko') == 'eceran' ? 'selected' : ''); ?>>
                                                    Toko Eceran
                                                </option>
                                            </select>
                                            <?php $__errorArgs = ['jenis_toko'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="tel" name="phone" id="phone"
                                                class="form-control border-start-0 <?php $__errorArgs = ['phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <textarea name="address" id="address" class="form-control border-start-0 <?php $__errorArgs = ['address'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                rows="1" placeholder="Masukkan alamat lengkap"><?php echo e(old('address')); ?></textarea>
                                        ...
                                        <div class="mt-2">
                                            <div class="form-check form-switch">
                                                ...
                                                <input type="checkbox" name="is_active" id="is_active"
                                                    ...
                                                    <?php echo e(old('is_active', true) ? 'checked' : ''); ?> role="switch">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT3\Toko-Roni-Mobile-App\tokoroni-app\resources\views\users\create.blade.php ENDPATH**/ ?>