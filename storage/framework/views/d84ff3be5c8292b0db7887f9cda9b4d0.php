...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', config('app.name', 'POS System')); ?></title>
            ...
            <div class="p-4 border-b border-gray-100 dark:border-gray-700 flex-shrink-0">
                <div class="flex items-center space-x-3">
                    ...
                    <div class="sidebar-hide overflow-hidden">
                        <div class="font-medium text-gray-800 dark:text-white text-sm truncate"><?php echo e(Auth::user()->name); ?>
            ...
            <div class="flex-1 overflow-y-auto scrollbar-thin py-4 px-3">
                <nav class="space-y-1">
                    ...
                    <a href="<?php echo e(route('dashboard')); ?>"
                        class="sidebar-tooltip sidebar-menu-item flex items-center px-3 py-2.5 rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('dashboard') ? 'bg-blue-50 text-blue-600 dark:bg-blue-900/50 dark:text-blue-400' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700/50'); ?>"
                    ...
                    <?php if(in_array(Auth::user()->role, ['owner', 'manager'])): ?>
                        ...
                        <a href="<?php echo e(route('users.index')); ?>"
                            class="sidebar-tooltip sidebar-menu-item flex items-center px-3 py-2.5 rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('users.*') ? 'bg-blue-50 text-blue-600 dark:bg-blue-900/50 dark:text-blue-400' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700/50'); ?>"
                            data-tooltip="Users">
                            <div class="sidebar-menu-icon w-5 h-5 flex items-center justify-center mr-3">
                        ...
                        <a href="<?php echo e(route('reports.sales')); ?>"
                            class="sidebar-tooltip sidebar-menu-item flex items-center px-3 py-2.5 rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('reports.*') ? 'bg-blue-50 text-blue-600 dark:bg-blue-900/50 dark:text-blue-400' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700/50'); ?>"
                    ...
                    <?php endif; ?>
                    <?php if(in_array(Auth::user()->role, ['kasir'])): ?>
                        <!-- Management Section -->
                        <div class="sidebar-hide pt-3 mt-2 border-t border-gray-100 dark:border-gray-700">
                            <div class="px-3 mb-1">
                                <div class="text-[10px] font-semibold text-gray-400 uppercase tracking-wider">Management
                    ...
                    <?php if(in_array(Auth::user()->role, ['kasir', 'owner', 'manager'])): ?>
                        <!-- Transaction Section -->
                        <div class="sidebar-hide pt-3 mt-2 border-t border-gray-100 dark:border-gray-700">
                            <div class="px-3 mb-1">
                        ...
                        <a href="<?php echo e(route('transactions.create')); ?>"
                            class="sidebar-tooltip sidebar-menu-item flex items-center px-3 py-2.5 rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('transactions.create') ? 'bg-blue-50 text-blue-600 dark:bg-blue-900/50 dark:text-blue-400' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700/50'); ?>"
                        ...
                        <a href="<?php echo e(route('members.index')); ?>"
                            class="sidebar-tooltip sidebar-menu-item flex items-center px-3 py-2.5 rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('members.*') ? 'bg-blue-50 text-blue-600 dark:bg-blue-900/50 dark:text-blue-400' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700/50'); ?>"
                            data-tooltip="Member">
                            <div class="sidebar-menu-icon w-5 h-5 flex items-center justify-center mr-3">
                    ...
                    <?php if(in_array(Auth::user()->role, ['owner', 'manager', 'kepala_gudang', 'checker_barang', 'kasir'])): ?>
                        <!-- Inventory Section -->
                        <div class="sidebar-hide pt-3 mt-2 border-t border-gray-100 dark:border-gray-700">
                            <div class="px-3 mb-1">
                        ...
                        <a href="<?php echo e(route('products.index')); ?>"
                            class="sidebar-tooltip sidebar-menu-item flex items-center px-3 py-2.5 rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('products.*') ? 'bg-blue-50 text-blue-600 dark:bg-blue-900/50 dark:text-blue-400' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700/50'); ?>"
                        ...
                        <?php if(in_array(Auth::user()->role, ['owner', 'manager', 'kepala_gudang'])): ?>
                        <a href="<?php echo e(route('categories.index')); ?>"
                            class="sidebar-tooltip sidebar-menu-item flex items-center px-3 py-2.5 rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('categories.*') ? 'bg-blue-50 text-blue-600 dark:bg-blue-900/50 dark:text-blue-400' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700/50'); ?>"
                    ...
                    <!-- Delivery Section -->
                    <?php if(in_array(Auth::user()->role, ['owner', 'manager', 'logistik', 'kepala_gudang'])): ?>
                    <div class="sidebar-hide pt-3 mt-2 border-t border-gray-100 dark:border-gray-700">
                        <div class="px-3 mb-1">
                    ...
                    <a href="<?php echo e(route('vehicles.index')); ?>"
                        class="sidebar-tooltip sidebar-menu-item flex items-center px-3 py-2.5 rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('vehicles.*') ? 'bg-blue-50 text-blue-600 dark:bg-blue-900/50 dark:text-blue-400' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700/50'); ?>"
                    ...
                    <a href="<?php echo e(route('profile.edit')); ?>"
                        class="sidebar-tooltip sidebar-menu-item flex items-center px-3 py-2.5 rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('profile.*') ? 'bg-blue-50 text-blue-600 dark:bg-blue-900/50 dark:text-blue-400' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700/50'); ?>"
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-600 dark:text-gray-400">
                            <span id="greeting"><?php echo e($greeting ?? 'Good Night'); ?></span>, <?php echo e(Auth::user()->name); ?>
...
<?php endif; ?>
                    ...
                    <div class="flex items-center space-x-2 cursor-pointer hover:opacity-80 transition-opacity">
                        ...
                        <div class="hidden md:block">
                            <div class="font-medium text-gray-800 dark:text-white text-sm"><?php echo e(Auth::user()->name); ?>

                            </div>
                            <div class="text-xs text-gray-500 dark:text-gray-400"><?php echo e(ucfirst(Auth::user()->role)); ?>
                ...
                <?php if(session('error')): ?>
                    <div class="mb-4 p-3 bg-red-50 border border-red-200 rounded-lg dark:bg-red-900/30 dark:border-red-800 animate-fade-in"
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-3 flex-1">
                                <p class="text-red-800 dark:text-red-300 text-sm font-medium"><?php echo e(session('error')); ?>
                ...
                <?php if(session('info')): ?>
                    <div class="mb-4 p-3 bg-blue-50 border border-blue-200 rounded-lg dark:bg-blue-900/30 dark:border-blue-800 animate-fade-in"
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-3 flex-1">
                                <p class="text-blue-800 dark:text-blue-300 text-sm font-medium"><?php echo e(session('info')); ?>
                ...
                <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                    <div class="text-xs text-gray-600 dark:text-gray-400">
                        <div class="flex items-center space-x-2">
                            ...
                            <div>
                                <p class="font-medium">© <?php echo e(date('Y')); ?> TOKO RONI</p>
                    ...
                    <div class="mt-2 md:mt-0 text-xs text-gray-500 dark:text-gray-400">
                        <div class="flex items-center space-x-3">
                            <div class="flex items-center">
                                ...
                                <span class="font-medium"><?php echo e(ucfirst(Auth::user()->role)); ?> Access</span>
                            </div>
                            <div class="flex items-center">
                                <i class="fas fa-calendar-alt mr-1 text-blue-500 text-[10px]"></i>
                                <span id="current-date" class="font-medium"><?php echo e(now()->format('l, d F Y')); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        (function() {
            ...
            const appKey = <?php echo json_encode(env('REVERB_APP_KEY'), 15, 512) ?>;
            const wsPort = <?php echo json_encode((int) env('REVERB_PORT', 8080), 512) ?>;
            const wsScheme = <?php echo json_encode(env('REVERB_SCHEME', 'http'), 512) ?>;
...
<?php /**PATH D:\laravel project 3\Toko-Roni-Mobile-App\resources\views/layouts/app.blade.php ENDPATH**/ ?>