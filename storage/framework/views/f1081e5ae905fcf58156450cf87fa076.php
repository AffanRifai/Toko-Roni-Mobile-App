<?php $__env->startSection('title', 'AI Sales Forecasting & Restock Planner'); ?>
...
<div class="container mx-auto px-4 py-8">
        ...
        <div class="bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl p-4 text-white">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold">Rp <?php echo e(number_format(array_sum(array_column($salesForecast ?? [], 'value')), 0, ',', '.')); ?></p>
                </div>
        ...
        <div class="bg-gradient-to-r from-green-500 to-green-600 rounded-xl p-4 text-white">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold"><?php echo e($restockPlan['total_urgent_items'] ?? 0); ?> Produk</p>
                </div>
        ...
        <div class="bg-gradient-to-r from-purple-500 to-purple-600 rounded-xl p-4 text-white">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold">Rp <?php echo e(number_format(($salesForecast[0]['value'] ?? 0), 0, ',', '.')); ?></p>
                </div>
        ...
        <div class="bg-gradient-to-r from-orange-500 to-orange-600 rounded-xl p-4 text-white">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold"><?php echo e($salesForecast[0]['confidence'] ?? 85); ?>%</p>
                </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
        ...
        <div class="bg-white rounded-xl shadow-md p-6 border border-gray-100">
            ...
            <div class="mt-4 grid grid-cols-7 gap-2 text-center text-xs">
                <?php $__currentLoopData = $salesForecast ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="p-2 rounded-lg <?php echo e($loop->index == 0 ? 'bg-indigo-50' : ''); ?>">
                    <p class="font-semibold"><?php echo e($day['day']); ?></p>
                    <p class="text-indigo-600 font-bold">Rp <?php echo e(number_format($day['value'], 0, ',', '.')); ?></p>
                    <p class="text-gray-400 text-[10px]">Conf: <?php echo e($day['confidence']); ?>%</p>
                </div>
    ...
    <div class="bg-white rounded-xl shadow-md p-6 border border-gray-100 mb-8">
        ...
        <?php if(!empty($restockPlan['urgent']) && count($restockPlan['urgent']) > 0): ?>
        <div class="mb-6">
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        <?php $__currentLoopData = $restockPlan['urgent']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="hover:bg-red-50 transition">
                            <td class="px-4 py-3">
                                <div>
                                    <p class="font-medium text-gray-900"><?php echo e($product['name']); ?></p>
                                    <p class="text-xs text-gray-500"><?php echo e($product['code']); ?></p>
                                </div>
                            </td>
                            <td class="px-4 py-3 text-center">
                                <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-red-100 text-red-800">
                                    <?php echo e($product['current_stock']); ?> <?php echo e($product['unit']); ?>

                                </span>
                            </td>
                            <td class="px-4 py-3 text-center font-semibold text-orange-600">
                                <?php echo e($product['projected_demand']); ?> <?php echo e($product['unit']); ?>

                            </td>
                            <td class="px-4 py-3 text-center font-bold text-red-600">
                                <?php echo e($product['needed_qty']); ?> <?php echo e($product['unit']); ?>

                            </td>
                            <td class="px-4 py-3 text-center text-gray-600">
                                <?php echo e($product['daily_avg_sales']); ?> <?php echo e($product['unit']); ?>/hari
                            </td>
                            <td class="px-4 py-3 text-center">
                                <button onclick="openRestockModal(<?php echo e($product['id']); ?>, '<?php echo e($product['name']); ?>', <?php echo e($product['current_stock']); ?>, <?php echo e($product['needed_qty']); ?>)"
        ...
        <?php if(!empty($restockPlan['planned']) && count($restockPlan['planned']) > 0): ?>
        <div>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        <?php $__currentLoopData = $restockPlan['planned']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <?php if(empty($restockPlan['urgent']) && empty($restockPlan['planned'])): ?>
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm text-gray-700">
                        ...
                        <li class="flex items-start gap-2">
                            ...
                            <span>Puncak penjualan diprediksi pada <strong><?php echo e($peakDay['day']); ?></strong> dengan estimasi Rp <?php echo e(number_format($peakDay['value'], 0, ',', '.')); ?></span>
                        </li>
                        <?php endif; ?>
                        <?php if(!empty($restockPlan['urgent'])): ?>
                        <li class="flex items-start gap-2">
                            <i class="fas fa-boxes text-orange-500 mt-1"></i>
                            <span>Segera restock <strong><?php echo e(count($restockPlan['urgent'])); ?> produk</strong> untuk menghindari kehabisan stok</span>
                        </li>
                        <?php endif; ?>
                        <li class="flex items-start gap-2">
...
<script>
    ...
    const dailyData = <?php echo json_encode($salesForecast, 15, 512) ?>;
    ...
    const monthlyData = <?php echo json_encode($monthlyForecast, 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Toko-Roni-Mobile-App\resources\views/forecast/index.blade.php ENDPATH**/ ?>