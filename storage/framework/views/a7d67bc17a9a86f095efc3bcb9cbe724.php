    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <div class="stat-card group">
            ...
            <div class="stat-card-content">
                ...
                <h3 class="text-2xl font-bold text-amber-600">Rp <?php echo e(number_format($member->total_piutang, 0, ',', '.')); ?></h3>
                <p class="text-xs text-gray-400 mt-1">Dari limit Rp <?php echo e(number_format($member->limit_kredit, 0, ',', '.')); ?></p>
            </div>
        </div>
                    ...
                    <tr class="hover:bg-white/30 transition-colors">
                        ...
                        <td class="px-6 py-4 text-sm">
                            <?php if($receivable->jatuh_tempo): ?>
                                ...
                                ?>
                                <span class="<?php echo e($jatuhTempo < $now && $receivable->status != 'LUNAS' ? 'text-red-600 font-medium' : ''); ?>">
                        ...
                        <td class="px-6 py-4">
                            <?php
                                $statusClass = $receivable->status == 'LUNAS' ? 'bg-green-100 text-green-800' : 'bg-amber-100 text-amber-800';
                            ?>
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-2">
                                ...
                                <?php if($receivable->invoice_number): ?>
                                ...
                                title="Riwayat Pembayaran - <?php echo e($receivable->no_piutang); ?>">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="jumlah_bayar" id="jumlah_bayar" required min="1" step="1"
...
window.showPayModal = function(id, noPiutang, sisa) {
    console.log('Opening payment modal for:', { id, noPiutang, sisa });
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Toko-Roni-Mobile-App\resources\views/members/receivables.blade.php ENDPATH**/ ?>