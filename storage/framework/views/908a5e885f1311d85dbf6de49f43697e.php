                ...
                <div class="flex items-center justify-between mb-4">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <h3 class="text-xl md:text-2xl font-bold text-gray-800 mt-1"><?php echo e($todayDeliveries ?? 0); ?></h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex items-center justify-between mb-4">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <h3 class="text-xl md:text-2xl font-bold text-gray-800 mt-1"><?php echo e($ongoingDeliveries ?? 0); ?></h3>
                        </div>
                    </div>
                </div>
                <div class="flex items-center justify-between">
                ...
                <div class="flex items-center justify-between mb-4">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <h3 class="text-xl md:text-2xl font-bold text-gray-800 mt-1"><?php echo e($totalItemsShipped ?? 0); ?></h3>
                        </div>
                    </div>
                </div>
                <div class="flex items-center justify-between">
                    <div class="flex items-center text-xs">
                        <span class="text-gray-500"><?php echo e($totalWeight ?? 0); ?> kg</span>
                        <span class="text-blue-600 font-semibold ml-2"><?php echo e($totalVolume ?? 0); ?> m³</span>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="flex items-center justify-between mb-4">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <h3 class="text-xl md:text-2xl font-bold text-gray-800 mt-1"><?php echo e($onTimeRate ?? 95); ?>%</h3>
                        </div>
                    </div>
                </div>
                <div class="flex items-center justify-between">
                    <div class="flex items-center text-xs">
                        <div class="w-16 h-2 bg-gray-200 rounded-full overflow-hidden">
                            <div class="h-full bg-emerald-500 rounded-full" style="width: <?php echo e($onTimeRate ?? 95); ?>%"></div>
                        </div>
                        ...
                        <div class="flex items-center justify-between mb-3">
                            <div class="flex items-center gap-3">
                                <div class="w-10 h-10 rounded-xl
                                    <?php echo e($delivery->status === 'on_the_way' ? 'bg-blue-100 text-blue-600' :
                                       ($delivery->status === 'loading' ? 'bg-amber-100 text-amber-600' :
                                        'bg-emerald-100 text-emerald-600')); ?> flex items-center justify-center">
                                    <?php if($delivery->status === 'on_the_way'): ?>
                                        <i class="fas fa-truck-moving"></i>
                                    <?php elseif($delivery->status === 'loading'): ?>
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500 mt-1">
                                        <?php echo e($delivery->driver_name); ?> • <?php echo e($delivery->vehicle_number); ?>

                                    </p>
                                </div>
                            </div>
                            <div class="text-right">
                                <div class="text-lg font-bold text-gray-900"><?php echo e($delivery->items_count); ?> items</div>
                                <span class="inline-block mt-1 px-2 py-1 rounded-full text-xs font-medium
                                    <?php echo e($delivery->status === 'on_the_way' ? 'bg-blue-100 text-blue-800' :
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex-1">
                                <div class="flex items-center justify-between text-xs text-gray-500 mb-1">
                                    <span><?php echo e($delivery->from_location); ?></span>
                                    <span><?php echo e($delivery->to_location); ?></span>
                                </div>
                                ...
                                <div class="flex items-center justify-between text-xs text-gray-500 mt-1">
                                    <span>ETA: <?php echo e($delivery->eta); ?></span>
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex items-center justify-between p-3 rounded-lg
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <div>
                                <p class="text-xs font-medium text-gray-900"><?php echo e($vehicle->name); ?></p>
                                <p class="text-xs text-gray-500"><?php echo e($vehicle->type); ?></p>
                            </div>
                        </div>
                        <div class="text-right">
                            <span class="text-sm font-bold text-gray-900"><?php echo e($vehicle->license_plate); ?></span>
                            <p class="text-xs text-gray-500"><?php echo e(ucfirst($vehicle->status)); ?></p>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT3\Toko-Roni-Mobile-App\tokoroni-app\resources\views\dashboard\logistik.blade.php ENDPATH**/ ?>