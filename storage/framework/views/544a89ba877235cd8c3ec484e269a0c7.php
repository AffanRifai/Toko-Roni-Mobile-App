                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="space-y-3">
                                    <div class="flex justify-between py-2 border-b border-gray-100">
                                        ...
                                        <span class="font-medium text-gray-900">
                                            <?php if($vehicle->type == 'motorcycle'): ?>
                                                🏍️ Motor
                                            <?php elseif($vehicle->type == 'pickup'): ?>
                                                🚗 Pickup
                                            <?php elseif($vehicle->type == 'van'): ?>
                                                🚗 Van
                                            <?php else: ?>
                                                🚛 Truck
                                            <?php endif; ?>
                                    ...
                                    <div class="flex justify-between py-2 border-b border-gray-100">
                                        ...
                                        <span class="font-medium text-gray-900">
                                            <?php if($vehicle->capacity_weight): ?>
                                                <?php echo e(number_format($vehicle->capacity_weight, 0)); ?> kg
                                            <?php else: ?>
                                                Tidak ditentukan
                                            <?php endif; ?>
                                        </span>
                                    ...
                                    <div class="flex justify-between py-2 border-b border-gray-100">
                                        ...
                                        <span class="font-medium text-gray-900">
                                            <?php if($vehicle->capacity_volume): ?>
                                                <?php echo e(number_format($vehicle->capacity_volume, 1)); ?> m³
                                            <?php else: ?>
                                                Tidak ditentukan
                                            <?php endif; ?>
                                        </span>
                            ...
                            <div>
                                ...
                                <div class="space-y-3">
                                    <div class="flex justify-between py-2 border-b border-gray-100">
                                        ...
                                        <span class="font-medium text-gray-900">
                                            <?php if($vehicle->last_maintenance): ?>
                                                <?php echo e(\Carbon\Carbon::parse($vehicle->last_maintenance)->format('d/m/Y')); ?>
                                    ...
                                    <?php if($vehicle->days_since_maintenance !== null): ?>
                                        <div class="flex justify-between py-2 border-b border-gray-100">
                                            <span class="text-gray-600">Hari Sejak Servis</span>
                                            <span class="font-medium <?php echo e($vehicle->days_since_maintenance > 30 ? 'text-red-600' : ($vehicle->days_since_maintenance == 0 ? 'text-green-600' : 'text-gray-900')); ?>">
                                                <?php if($vehicle->days_since_maintenance == 0): ?>
                                                    Hari ini
                                                <?php else: ?>
                                                    <?php echo e($vehicle->days_since_maintenance); ?> hari
                                                <?php endif; ?>
                                        ...
                                        <div class="flex justify-between py-2">
                                            ...
                                            <span class="font-medium">
                                                ...
                                                <?php elseif($vehicle->needs_maintenance_soon): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Toko-Roni-Mobile-App\resources\views/vehicles/show.blade.php ENDPATH**/ ?>