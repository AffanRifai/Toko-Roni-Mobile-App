            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                    <select name="payment_method" onchange="this.form.submit()" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                        <option value="all" <?php echo e(request('payment_method') == 'all' || !request('payment_method') ? 'selected' : ''); ?>>Semua Pembayaran</option>
                        <option value="cash" <?php echo e(request('payment_method') == 'cash' ? 'selected' : ''); ?>>💵 Cash (Tunai)</option>
                        <option value="debit_card" <?php echo e(request('payment_method') == 'debit_card' ? 'selected' : ''); ?>>💳 Debit Card</option>
                        <option value="credit_card" <?php echo e(request('payment_method') == 'credit_card' ? 'selected' : ''); ?>>🏦 Credit Card (Hutang)</option>
                ...
                <!-- Tombol Reset Filter -->
                <div>
                    <?php if(request('search') || request('payment_method') || request('start_date') || request('end_date')): ?>
                        <a href="<?php echo e(route('transactions.index')); ?>" class="inline-flex items-center justify-center w-full px-4 py-2 bg-red-50 text-red-600 rounded-lg hover:bg-red-100 transition-colors">
                        ...
                        <td class="px-6 py-4 text-center">
                            ...
                            <div class="flex flex-col items-center gap-1">
                                <span class="inline-flex items-center gap-1 px-2 py-1 rounded-full border text-xs font-medium <?php echo e($paymentColors[$transaction->payment_method] ?? 'bg-gray-100 text-gray-800 border-gray-200'); ?>">
                                    ...
                                    <?php echo e($paymentLabels[$transaction->payment_method] ?? ucfirst(str_replace('_', ' ', $transaction->payment_method))); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Toko-Roni-Mobile-App\resources\views/transactions/index.blade.php ENDPATH**/ ?>