...
<?php $__env->startSection('page-subtitle', 'Kelola semua produk dan kategori dalam satu dashboard'); ?>
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-6">
            ...
            <?php $__currentLoopData = $statsConfig; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="stat-card group">
                    <div class="stat-card-glow bg-gradient-to-r <?php echo e($stat['gradient']); ?>"></div>
                    <div class="stat-card-content">
                        <div class="flex items-center justify-between mb-4">
                            <div class="flex items-center gap-3">
                                <div class="p-3 rounded-xl bg-gradient-to-br <?php echo e($stat['iconBg']); ?> shadow-lg">
                                    <i class="fas fa-<?php echo e($stat['icon']); ?> text-white"></i>
                                </div>
                                <div>
                                    <p class="text-sm text-gray-500"><?php echo e($stat['label']); ?></p>
                                    <h3 class="text-2xl font-bold text-gray-800"><?php echo e(number_format($stat['value'])); ?></h3>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6 mb-6">
            ...
            <div class="glass-effect rounded-2xl p-5">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <span class="text-2xl font-bold text-amber-600"><?php echo e($expiringSoonCount ?? 0); ?></span>
                </div>

                <?php if(isset($expiringProducts) && $expiringProducts->count() > 0): ?>
                            ...
                            <div class="flex items-center justify-between p-3 bg-white/50 rounded-xl hover:bg-white transition-all">
                                <div class="flex items-center gap-3 min-w-0">
                                    ...
                                    <div class="min-w-0">
                                        ...
                                        <p class="text-xs text-gray-500">Stok: <?php echo e(number_format($product->stock)); ?> <?php echo e($product->unit); ?></p>
                                    </div>
                                </div>
                                <div class="text-right flex-shrink-0 ml-2">
                                    <span class="text-xs font-medium px-2 py-1 rounded-full <?php echo e($expiryClass); ?>">
                                        <?php echo e($daysLeft == 0 ? 'Hari ini' : $daysLeft . ' hari lagi'); ?>

                                    </span>
                                    <p class="text-xs text-gray-500 mt-1"><?php echo e(Carbon\Carbon::parse($product->expiry_date)->format('d/m/Y')); ?></p>
                                </div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
            ...
            <div class="glass-effect rounded-2xl p-5">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <span class="text-2xl font-bold text-red-600"><?php echo e($expiredCount ?? 0); ?></span>
                </div>

                <?php if(isset($expiredProducts) && $expiredProducts->count() > 0): ?>
                    <div class="space-y-3 max-h-80 overflow-y-auto pr-2 custom-scrollbar">
                            ...
                            <div class="flex items-center justify-between p-3 bg-red-50/50 rounded-xl hover:bg-red-50 transition-all">
                                ...
                                <div class="text-right flex-shrink-0 ml-2">
                                    <span class="text-xs font-medium px-2 py-1 rounded-full bg-red-100 text-red-800">
                                        Expired <?php echo e($daysExpired == 0 ? 'hari ini' : $daysExpired . ' hari lalu'); ?>
        ...
        <div class="glass-effect rounded-2xl p-5 mb-6">
            <div class="flex items-center justify-between mb-4">
                ...
                <div class="flex items-center gap-2 text-sm">
                    <span class="text-gray-500" id="filterResultCount"><?php echo e($products->total()); ?> produk ditemukan</span>
                </div>
            </div>
                ...
                <div class="relative">
                    <select id="categoryFilter"
                        ...
                        <?php $__currentLoopData = $categories ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($category->id); ?>"><?php echo e($category->name); ?> (<?php echo e($category->products_count ?? 0); ?>)</option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
        ...
        <div id="productsContainer" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
            <?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <div class="product-card group bg-white/80 backdrop-blur-sm rounded-2xl shadow-soft border border-white/50 overflow-hidden hover:shadow-xl hover:-translate-y-1 transition-all duration-300"
                    data-category="<?php echo e($product->category_id ?? ''); ?>" data-status="<?php echo e($product->is_active); ?>"
                    ...
                    <div class="relative h-48 bg-gradient-to-br from-gray-100 to-gray-200 overflow-hidden">
                        ...
                        <div class="absolute inset-0 bg-gradient-to-t from-black/50 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                            <div class="absolute bottom-3 left-3 right-3 flex justify-center gap-2">
                                <button onclick="showQuickView(<?php echo e($product->id); ?>)"
                                ...
                                <button onclick="confirmDelete(<?php echo e($product->id); ?>, '<?php echo e($product->name); ?>')"
                        ...
                        <div class="absolute top-3 left-3 flex flex-col gap-1">
                            <span class="badge <?php echo e($statusBadgeClasses[$product->is_active]); ?>">
                                <i class="fas fa-<?php echo e($product->is_active ? 'check-circle' : 'ban'); ?> mr-1 text-xs"></i>
                                <?php echo e($product->is_active ? 'Aktif' : 'Nonaktif'); ?>

                            </span>
                            <span class="badge <?php echo e($stockBadgeClasses[$stockStatus]); ?>">
                                <i class="fas fa-<?php echo e($stockStatus == 'out' ? 'times-circle' : ($stockStatus == 'low' ? 'exclamation-circle' : 'check-circle')); ?> mr-1 text-xs"></i>
                                <?php echo e($stockStatus == 'out' ? 'Habis' : ($stockStatus == 'low' ? 'Stok Rendah' : 'Tersedia')); ?>
                            ...
                            <?php if($product->expiry_date): ?>
                                ...
                                <?php elseif($daysLeft <= 30): ?>
                                    <span class="badge bg-amber-100 text-amber-800 border border-amber-200">
                                        ...
                                        <?php echo e($daysLeft == 0 ? 'Hari ini' : $daysLeft . ' hari'); ?>
                    ...
                    <div class="p-5">
                        ...
                        <div class="flex items-center justify-between mb-2">
                            <span class="text-xs font-mono text-gray-500 bg-gray-100 px-2 py-1 rounded-lg"><?php echo e($product->code); ?></span>
                        ...
                        <div class="flex items-end justify-between mt-3 pt-3 border-t border-gray-100">
                            ...
                            <div class="text-right">
                                ...
                                <p class="text-lg font-semibold <?php echo e($stockStatus == 'out' ? 'text-red-600' : ($stockStatus == 'low' ? 'text-amber-600' : 'text-emerald-600')); ?>">
                                    <?php echo e(number_format($product->stock)); ?>

                                    <span class="text-xs font-normal text-gray-500"><?php echo e($product->unit); ?></span>
                                </p>
                            </div>
                        </div>
                        ...
                        <?php if($product->expiry_date): ?>
                            <div class="mt-2 text-xs text-gray-500 flex items-center gap-1">
                                ...
                                Exp: <?php echo e(Carbon\Carbon::parse($product->expiry_date)->format('d/m/Y')); ?>
            ...
            <div class="glass-effect rounded-3xl p-6">
                <div class="flex items-center justify-between mb-6">
                    <div>
                        ...
                        <p class="text-sm text-gray-600 mt-1"><?php echo e($categories->count()); ?> kategori tersedia</p>
                    </div>
                </div>
                            ...
                            <div class="group bg-white/50 backdrop-blur-sm rounded-xl p-4 border border-gray-200/50 hover:border-purple-200 hover:shadow-md transition-all">
                                <div class="flex items-start justify-between">
                                    ...
                                    <div class="flex gap-1">
                                        <button onclick="editCategory(<?php echo e($category->id); ?>, '<?php echo e($category->name); ?>')"
    ...
    <div id="categoryModal" class="modal hidden">
        <div class="modal-content max-w-md">
            ...
            <div class="modal-body p-6">
                <form id="categoryForm" method="POST" action="<?php echo e(route('categories.store')); ?>" class="space-y-4">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT3\Toko-Roni-Mobile-App\tokoroni-app\resources\views\products\index.blade.php ENDPATH**/ ?>