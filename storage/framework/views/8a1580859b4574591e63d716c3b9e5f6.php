...
<div class="min-h-screen bg-gray-50 p-4 md:p-6">
    <div class="max-w-7xl mx-auto">
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                <div>
                    <nav class="flex items-center space-x-2 text-sm text-gray-600 mb-3">
                        <a href="<?php echo e(route('dashboard')); ?>" class="hover:text-blue-600 transition-colors">
                            <i class="fas fa-home"></i>
                        </a>
                        <i class="fas fa-chevron-right text-xs"></i>
                        <a href="<?php echo e(route('reports.index')); ?>" class="hover:text-blue-600 transition-colors">
                            Laporan
                        </a>
                        <i class="fas fa-chevron-right text-xs"></i>
                ...
                <div class="flex flex-wrap gap-3">
                    <form action="<?php echo e(route('reports.sales.export')); ?>" method="POST" class="inline">
                        <?php echo csrf_field(); ?>
                    ...
                    <div class="relative">
                        <div class="flex justify-between items-start">
                            <div>
                                ...
                                <h3 class="text-2xl font-bold">Rp <?php echo e(number_format($total, 0, ',', '.')); ?></h3>
                            </div>
                        ...
                        <?php if(isset($comparison) && $comparison['total'] != 0): ?>
                        <div class="mt-5 pt-4 border-t border-blue-500/30">
                            <div class="flex items-center justify-between mb-2">
                                ...
                                <div class="flex items-center gap-1">
                                    ...
                                    ?>
                                    <span class="text-<?php echo e($isPositive ? 'green' : 'red'); ?>-300 text-sm font-medium px-2 py-0.5 bg-white/10 rounded-full">
                                        <i class="fas fa-<?php echo e($isPositive ? 'arrow-up' : 'arrow-down'); ?> mr-1"></i>
                                        <?php echo e(number_format(abs($percentageChange), 1)); ?>%
                                    </span>
                                </div>
                            </div>
                            <div class="flex justify-between items-center text-xs">
                                <span class="text-blue-200">Periode Sekarang</span>
                                <span class="text-white font-medium">Rp <?php echo e(number_format($total, 0, ',', '.')); ?></span>
                            </div>
                            <div class="flex justify-between items-center text-xs mt-1">
                                <span class="text-blue-200">Periode Lalu</span>
                                <span class="text-blue-200">Rp <?php echo e(number_format($comparison['total'], 0, ',', '.')); ?></span>
                            </div>
                        </div>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="relative">
                        <div class="flex justify-between items-start">
                            <div>
                                ...
                                <h3 class="text-2xl font-bold text-gray-900">Rp <?php echo e(number_format($averageTransaction, 0, ',', '.')); ?></h3>
                            </div>
                        ...
                        <?php if(isset($comparison) && $comparison['avg'] != 0): ?>
                        <div class="mt-5 pt-4 border-t border-gray-200">
                            <div class="flex items-center justify-between mb-2">
                                ...
                                <div class="flex items-center gap-1">
                                    <?php
                                        ...
                                        $isPositive = $percentageChange > 0;
                                    ?>
                                    <span class="text-<?php echo e($isPositive ? 'green' : 'red'); ?>-600 text-sm font-medium">
                                        <i class="fas fa-<?php echo e($isPositive ? 'arrow-up' : 'arrow-down'); ?> mr-1"></i>
                                        <?php echo e(number_format(abs($percentageChange), 1)); ?>%
                                    </span>
                                </div>
                            ...
                            <div class="flex justify-between items-center text-xs">
                                ...
                                <span class="font-medium text-gray-900">Rp <?php echo e(number_format($averageTransaction, 0, ',', '.')); ?></span>
                            </div>
                            <div class="flex justify-between items-center text-xs mt-1">
                                <span class="text-gray-500">Kemarin</span>
                                <span class="text-gray-600">Rp <?php echo e(number_format($comparison['avg'], 0, ',', '.')); ?></span>
                            </div>
                        </div>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="relative">
                        <div class="flex justify-between items-start">
                            <div>
                                ...
                                <h3 class="text-2xl font-bold text-gray-900">Rp <?php echo e(number_format($maxTransaction, 0, ',', '.')); ?></h3>
                            </div>
                        ...
                        <!-- Comparison with previous month -->
                        <?php if(isset($comparison) && $comparison['max'] != 0): ?>
                        <div class="mt-5 pt-4 border-t border-gray-200">
                            <div class="flex items-center justify-between mb-2">
                                <span class="text-gray-600 text-sm flex items-center gap-1">
                                    <i class="fas fa-calendar-alt text-xs text-blue-600"></i>
                            ...
                            <div class="flex justify-between items-center text-xs">
                                <span class="text-gray-500">Sekarang</span>
                                <span class="font-medium text-gray-900">Rp <?php echo e(number_format($maxTransaction, 0, ',', '.')); ?></span>
                            </div>
                            <div class="flex justify-between items-center text-xs mt-1">
                                <span class="text-gray-500">Kemarin</span>
                                <span class="text-gray-600">Rp <?php echo e(number_format($comparison['max'], 0, ',', '.')); ?></span>
                            </div>
                        </div>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="relative">
                        <div class="flex justify-between items-start">
                            <div>
                                ...
                                <h3 class="text-2xl font-bold text-gray-900"><?php echo e(number_format($totalCount, 0)); ?></h3>
                            </div>
                        ...
                        <!-- Comparison with previous month -->
                        <?php if(isset($comparison) && $comparison['count'] != 0): ?>
                        <div class="mt-5 pt-4 border-t border-gray-200">
                            <div class="flex items-center justify-between mb-2">
                                <span class="text-gray-600 text-sm flex items-center gap-1">
                                    <i class="fas fa-calendar-alt text-xs text-blue-600"></i>
                            ...
                            <div class="flex justify-between items-center text-xs">
                                <span class="text-gray-500">Sekarang</span>
                                <span class="font-medium text-gray-900"><?php echo e(number_format($totalCount, 0)); ?> transaksi</span>
                            </div>
                            <div class="flex justify-between items-center text-xs mt-1">
                                <span class="text-gray-500">Kemarin</span>
                                <span class="text-gray-600"><?php echo e(number_format($comparison['count'], 0)); ?> transaksi</span>
                            </div>
                        </div>
                        <?php endif; ?>
                    </div>
                ...
                <div class="bg-white rounded-xl p-6 shadow border border-gray-200">
                    ...
                    <div class="mb-6">
                        <div class="flex items-center justify-between mb-3">
                            ...
                            <span class="text-xs text-gray-500">Periode: <?php echo e($period); ?> vs Bulan Lalu</span>
                        </div>
                        ...
                        <div class="space-y-4">
                            <div>
                                <div class="flex justify-between text-xs mb-1">
                                    ...
                                    <span class="font-medium text-blue-600">Rp <?php echo e(number_format($total, 0, ',', '.')); ?></span>
                                </div>
                            ...
                            <div>
                                <div class="flex justify-between text-xs mb-1">
                                    ...
                                    <span class="font-medium text-gray-600">Rp <?php echo e(number_format($comparison['total'], 0, ',', '.')); ?></span>
                                </div>
                                <div class="w-full bg-gray-200 rounded-full h-2.5">
                                    <?php
                                        $previousPercentage = $total > 0 ? min(($comparison['total'] / $total) * 100, 100) : 0;
                                    ?>
                                    <div class="bg-gray-400 h-2.5 rounded-full" style="width: <?php echo e($previousPercentage); ?>%"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                            ...
                            <span class="font-semibold text-lg <?php echo e($totalChange > 0 ? 'text-green-600' : ($totalChange < 0 ? 'text-red-600' : 'text-gray-600')); ?>">
                                <?php echo e($totalChange > 0 ? '+' : ''); ?><?php echo e(number_format($totalChange, 1)); ?>%
                                <i class="fas fa-<?php echo e($totalChange > 0 ? 'arrow-up' : ($totalChange < 0 ? 'arrow-down' : 'minus')); ?> ml-1"></i>
                            </span>
                        </div>
                ...
                <div class="bg-white rounded-xl p-6 shadow border border-gray-200">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex items-center justify-between p-3 hover:bg-gray-50 rounded-lg transition-colors border-b border-gray-100 last:border-0">
                            <div class="flex items-center gap-3">
                                <span class="w-7 h-7 flex items-center justify-center bg-<?php echo e($index == 0 ? 'yellow' : ($index == 1 ? 'gray' : ($index == 2 ? 'orange' : 'blue'))); ?>-100 text-<?php echo e($index == 0 ? 'yellow' : ($index == 1 ? 'gray' : ($index == 2 ? 'orange' : 'blue'))); ?>-600 rounded-full text-xs font-bold">
                                    <?php echo e($index + 1); ?>

                                </span>
                                <span class="text-sm font-medium text-gray-900"><?php echo e($product->name); ?></span>
                            </div>
                            <div class="flex items-center gap-2">
                                <span class="text-sm text-gray-600"><?php echo e($product->total_sold); ?> terjual</span>
                                <?php if($index == 0): ?>
                    ...
                    <div class="mt-5 pt-4 border-t border-gray-200">
                        <div class="flex justify-between text-sm">
                            ...
                            <span class="font-medium text-gray-900"><?php echo e($topProducts->sum('total_sold')); ?> unit</span>
                        </div>
                    </div>
                </div>
                <?php endif; ?>
        ...
        <div class="bg-white rounded-xl shadow border border-gray-200 mb-6 overflow-hidden">
            ...
            <div class="p-6">
                <form method="GET" action="<?php echo e(route('reports.sales')); ?>" class="space-y-4">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <select name="sort" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                                ...
                                <option value="highest" <?php echo e(request('sort') == 'highest' ? 'selected' : ''); ?>>Total Tertinggi</option>
                                <option value="lowest" <?php echo e(request('sort') == 'lowest' ? 'selected' : ''); ?>>Total Terendah</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-wrap gap-3 pt-2">
                        ...
                        <a href="<?php echo e(route('reports.sales')); ?>" class="px-5 py-2.5 bg-white border border-gray-300 text-gray-700 font-medium rounded-lg hover:bg-gray-50 transition-colors flex items-center gap-2">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="text-gray-400 text-xs"><?php echo e($transaction->created_at->format('H:i')); ?></span>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 font-mono">
                                <?php echo e($transaction->invoice_number ?? 'TRX-' . $transaction->id); ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                <?php echo e($transaction->customer_name ?? 'Pelanggan Umum'); ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <?php if($transaction->payment_method == 'credit_card' || $transaction->payment_method == 'hutang'): ?>
                                <span class="px-2 py-1 text-xs font-medium bg-yellow-100 text-yellow-800 rounded-full">
                                    <i class="fas fa-clock mr-1"></i> <?php echo e(ucfirst($transaction->payment_method)); ?>
            ...
            <div class="border-t border-gray-200 px-6 py-4">
                <div class="flex items-center justify-between">
                    <div class="text-sm text-gray-700">
                        Menampilkan <?php echo e($transactions->firstItem()); ?> - <?php echo e($transactions->lastItem()); ?> dari <?php echo e($transactions->total()); ?> transaksi
                    </div>
                    <div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT3\Toko-Roni-Mobile-App\tokoroni-app\resources\views\reports\sales.blade.php ENDPATH**/ ?>