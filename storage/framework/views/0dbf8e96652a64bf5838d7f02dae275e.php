    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <div class="stat-card group">
            ...
            <div class="stat-card-content">
                ...
                <p class="text-xs text-gray-400 mt-1">Dari limit Rp <?php echo e(number_format($member->limit_kredit)); ?></p>
            </div>
        </div>
        ...
        <div class="stat-card group">
            ...
            <div class="stat-card-content">
                ...
                <h3 class="text-2xl font-bold <?php echo e($sisaLimit > 0 ? 'text-green-600' : 'text-red-600'); ?>">
                    Rp <?php echo e(number_format($sisaLimit)); ?>
                    ...
                    <tr class="hover:bg-white/30 transition-colors">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-2">
                                ...
                                <?php endif; ?>
                                <a href="<?php echo e(route('receivables.payment-history', $receivable)); ?>"
