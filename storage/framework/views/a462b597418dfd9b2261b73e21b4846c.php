...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <option value="motor" <?php echo e(old('type', $vehicle->type) == 'motor' ? 'selected' : ''); ?>>
                                        Motor</option>
                                    <option value="mobil" <?php echo e(old('type', $vehicle->type) == 'mobil' ? 'selected' : ''); ?>>
                                        Mobil</option>
                                    <option value="truck" <?php echo e(old('type', $vehicle->type) == 'truck' ? 'selected' : ''); ?>>
                                        Truck</option>
                                </select>
                                <i
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT3\Toko-Roni-Mobile-App\tokoroni-app\resources\views\vehicles\edit.blade.php ENDPATH**/ ?>