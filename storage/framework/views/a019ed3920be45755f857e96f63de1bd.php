<?php $__env->startSection('title', 'Dashboard Logistik'); ?>
<?php $__env->startSection('page-title', 'Dashboard Logistik'); ?>
<?php $__env->startSection('page-subtitle', 'Manajemen Pengiriman & Distribusi'); ?>
            ...
            <div class="flex-1">
                ...
                <div class="flex flex-wrap gap-3">
                    <div class="flex items-center gap-2 px-3 py-2 bg-indigo-50 rounded-lg">
                        ...
                        <span class="text-sm font-medium text-gray-700">Armada: <?php echo e($totalFleet ?? 5); ?> unit</span>
                    </div>
                    <div class="flex items-center gap-2 px-3 py-2 bg-emerald-50 rounded-lg">
                        <i class="fas fa-map-marked-alt text-emerald-600"></i>
                        <span class="text-sm font-medium text-gray-700"><?php echo e($activeRoutes ?? 3); ?> rute aktif</span>
                    </div>
                    <div class="flex items-center gap-2 px-3 py-2 bg-amber-50 rounded-lg">
                        <i class="fas fa-clock text-amber-600"></i>
                        <span class="text-sm font-medium text-gray-700">Ongoing: <?php echo e($ongoingDeliveries ?? 2); ?></span>
                    </div>
                </div>
                
                <!-- TAMBAHKAN: Informasi untuk staff logistik -->
                <?php if(isset($isStaffLogistik) && $isStaffLogistik): ?>
                <div class="mt-4 bg-blue-50 border border-blue-200 rounded-xl p-3">
                    <div class="flex items-center gap-2">
                        <i class="fas fa-info-circle text-blue-600"></i>
                        <p class="text-sm text-blue-800">
                            Menampilkan pengiriman yang ditugaskan kepada <strong><?php echo e(Auth::user()->name); ?></strong>
                        </p>
                    </div>
                </div>
                <?php endif; ?>
        ...
        <div class="bg-white/80 backdrop-blur-sm rounded-2xl p-5 md:p-6 shadow-sm border border-white/50 hover:shadow-md transition-all">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3 md:gap-4">
                    ...
                    <div>
                        ...
                        <h3 class="text-xl md:text-3xl font-bold text-gray-800 mt-1"><?php echo e(number_format($todayDeliveries ?? 0)); ?></h3>
                    </div>
                </div>
                <a href="<?php echo e(route('delivery.index')); ?>?date=today" class="w-8 h-8 rounded-lg bg-gray-100 flex items-center justify-center text-gray-600 hover:bg-indigo-500 hover:text-white transition-all">
            ...
            <div class="flex items-center justify-between mt-4 pt-3 border-t border-gray-100">
                <div class="flex items-center text-xs md:text-sm">
                    ...
                    <span class="text-emerald-600 font-semibold"><?php echo e($completedDeliveries ?? 0); ?> selesai</span>
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3 md:gap-4">
                    ...
                    <div>
                        ...
                        <h3 class="text-xl md:text-3xl font-bold text-gray-800 mt-1"><?php echo e(number_format($ongoingDeliveries ?? 0)); ?></h3>
                    </div>
                </div>
                <a href="<?php echo e(route('delivery.index')); ?>?status=ongoing" class="w-8 h-8 rounded-lg bg-gray-100 flex items-center justify-center text-gray-600 hover:bg-amber-500 hover:text-white transition-all">
                    <i class="fas fa-arrow-right text-xs"></i>
                </a>
            </div>
            <div class="flex items-center justify-between mt-4 pt-3 border-t border-gray-100">
                <div class="flex items-center text-xs md:text-sm">
                    ...
                    <span class="text-amber-600 font-semibold"><?php echo e($delayedDeliveries ?? 0); ?> tertunda</span>
                </div>
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3 md:gap-4">
                    ...
                    <div>
                        ...
                        <h3 class="text-xl md:text-3xl font-bold text-gray-800 mt-1"><?php echo e(number_format($totalItemsShipped ?? 0)); ?></h3>
                    </div>
                </div>
                <a href="<?php echo e(route('delivery.index')); ?>?items=shipped" class="w-8 h-8 rounded-lg bg-gray-100 flex items-center justify-center text-gray-600 hover:bg-blue-500 hover:text-white transition-all">
                    <i class="fas fa-arrow-right text-xs"></i>
                </a>
            </div>
            <div class="flex items-center justify-between mt-4 pt-3 border-t border-gray-100">
                <div class="flex items-center text-xs md:text-sm">
                    <span class="text-gray-600"><?php echo e(number_format($totalWeight ?? 0)); ?> kg</span>
                    <span class="text-blue-600 font-semibold ml-2"><?php echo e(number_format($totalVolume ?? 0)); ?> m³</span>
                </div>
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3 md:gap-4">
                    ...
                    <div>
                        ...
                        <h3 class="text-xl md:text-3xl font-bold text-gray-800 mt-1"><?php echo e(number_format($onTimeRate ?? 95)); ?>%</h3>
                    </div>
                </div>
                <a href="<?php echo e(route('delivery.index')); ?>?performance=on-time" class="w-8 h-8 rounded-lg bg-gray-100 flex items-center justify-center text-gray-600 hover:bg-emerald-500 hover:text-white transition-all">
                    <i class="fas fa-arrow-right text-xs"></i>
                </a>
            </div>
            <div class="flex items-center justify-between mt-4 pt-3 border-t border-gray-100">
                <div class="flex items-center text-xs md:text-sm" style="width: 100%;">
                    <div class="flex-1 h-2 bg-gray-200 rounded-full overflow-hidden mr-2">
                        <div class="h-full bg-emerald-500 rounded-full" style="width: <?php echo e(min(100, $onTimeRate ?? 95)); ?>%"></div>
                    </div>
        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-3 md:gap-4">
                ...
                <div>
                    ...
                    <h3 class="text-xl md:text-3xl font-bold text-gray-800 mt-1"><?php echo e(number_format($availableFleet ?? 0)); ?></h3>
                </div>
            </div>
    ...
    <div class="flex items-center justify-between">
        <div class="flex items-center gap-3 md:gap-4">
            ...
            <div>
                ...
                <h3 class="text-xl md:text-3xl font-bold text-gray-800 mt-1"><?php echo e(number_format($activeDrivers ?? 0)); ?><span class="text-sm font-normal text-gray-500">/<?php echo e(number_format($totalDrivers ?? 0)); ?></span></h3>
            </div>
        </div>
        <div class="w-8 h-8 rounded-lg bg-gray-100 flex items-center justify-center text-gray-400">
        ...
        <div class="bg-white/80 backdrop-blur-sm rounded-2xl p-5 md:p-6 shadow-sm border border-white/50 hover:shadow-md transition-all">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3 md:gap-4">
                    ...
                    <div>
                        <p class="text-xs md:text-sm text-gray-500 font-medium">Driver Aktif</p>
                        <h3 class="text-xl md:text-3xl font-bold text-gray-800 mt-1"><?php echo e(number_format($totalDrivers ?? 0)); ?></h3>
                    </div>
                </div>
                <div class="w-8 h-8 rounded-lg bg-gray-100 flex items-center justify-center text-gray-400">
                    <i class="fas fa-users text-xs"></i>
        ...
        <div class="lg:col-span-2">
            <div class="glass-effect rounded-3xl overflow-hidden shadow-elegant h-full">
                ...
                <div class="divide-y divide-gray-100/50 max-h-96 overflow-y-auto elegant-scrollbar">
                    <?php $__empty_1 = true; $__currentLoopData = $activeDeliveries ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $delivery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="p-4 md:p-6 hover:bg-white/30 transition-colors duration-200">
                        <div class="flex items-center justify-between mb-3">
                            <div class="flex items-center gap-3">
                                <div class="w-10 h-10 rounded-xl
                                    <?php echo e($delivery->status === 'on_delivery' ? 'bg-blue-100 text-blue-600' :
                                    ...
                                    <?php elseif($delivery->status === 'assigned'): ?>
                                ...
                                <div>
                                    <h4 class="font-semibold text-gray-900"><?php echo e($delivery->delivery_code); ?></h4>
                                    <p class="text-xs text-gray-500 mt-1">
                                        <?php echo e($delivery->driver_name ?? 'Driver'); ?> • <?php echo e($delivery->vehicle_number ?? 'N/A'); ?>

                                    </p>
                                </div>
                            </div>
                            <div class="text-right">
                                <div class="text-lg font-bold text-gray-900"><?php echo e($delivery->items_count ?? 0); ?> items</div>
                                <span class="inline-block mt-1 px-2 py-1 rounded-full text-xs font-medium
                                    <?php echo e($delivery->status === 'on_delivery' ? 'bg-blue-100 text-blue-800' :
                                       ($delivery->status === 'picked_up' ? 'bg-indigo-100 text-indigo-800' :
                                        ($delivery->status === 'assigned' ? 'bg-amber-100 text-amber-800' :
                                        'bg-emerald-100 text-emerald-800'))); ?>">
                                    <?php echo e($delivery->status_label ?? ucfirst(str_replace('_', ' ', $delivery->status))); ?>
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex-1">
                                <div class="flex items-center justify-between text-xs text-gray-500 mb-1">
                                    <span><?php echo e($delivery->from_location ?? 'Gudang'); ?></span>
                                    <span><?php echo e($delivery->to_location ?? 'Tujuan'); ?></span>
                                </div>
                                <div class="h-2 bg-gray-200 rounded-full overflow-hidden">
                                    <div class="h-full bg-indigo-500 rounded-full"
                                         style="width: <?php echo e($delivery->progress ?? 50); ?>%"></div>
                                </div>
                                <div class="flex items-center justify-between text-xs text-gray-500 mt-1">
                                    <span>ETA: <?php echo e($delivery->eta ?? '15:00'); ?></span>
                                    <span><?php echo e($delivery->progress ?? 50); ?>%</span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div>
            <div class="glass-effect rounded-3xl p-4 md:p-6 shadow-elegant h-full">
                ...
                <div class="space-y-3 max-h-96 overflow-y-auto elegant-scrollbar pr-2">
                    <?php $__empty_1 = true; $__currentLoopData = $fleetStatus ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vehicle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="flex items-center justify-between p-3 rounded-lg
                        <?php echo e($vehicle->status === 'available' ? 'bg-emerald-50' :
                           ($vehicle->status === 'in_use' ? 'bg-blue-50' : 'bg-amber-50')); ?>">
                        <div class="flex items-center gap-2">
                            <div class="w-8 h-8 rounded-lg
                                <?php echo e($vehicle->status === 'available' ? 'bg-emerald-100 text-emerald-600' :
                                   ($vehicle->status === 'in_use' ? 'bg-blue-100 text-blue-600' : 'bg-amber-100 text-amber-600')); ?> flex items-center justify-center">
                                <i class="fas fa-truck text-xs"></i>
                            </div>
                            <div>
                                <p class="text-xs font-medium text-gray-900"><?php echo e($vehicle->name ?? 'Kendaraan'); ?></p>
                                <p class="text-xs text-gray-500"><?php echo e($vehicle->type ?? 'Unknown'); ?></p>
                            </div>
                        </div>
                        <div class="text-right">
                            <span class="text-sm font-bold text-gray-900"><?php echo e($vehicle->license_plate ?? 'N/A'); ?></span>
                            <p class="text-xs <?php echo e($vehicle->status === 'available' ? 'text-green-600' : ($vehicle->status === 'in_use' ? 'text-blue-600' : 'text-amber-600')); ?>">
                                <?php echo e($vehicle->status_display ?? ucfirst($vehicle->status ?? 'unknown')); ?>
                ...
                <div>
                    ...
                    <p class="text-xs md:text-sm text-gray-600 mt-1">
                        ...
                        <span id="chartRangeLabel">
                            <?php if($chartRange == 7): ?> 7 hari terakhir
                            <?php elseif($chartRange == 30): ?> 30 hari terakhir
                            <?php else: ?> 90 hari terakhir
                            <?php endif; ?>
                        </span>
                    </p>
                </div>
                ...
                <div class="flex items-center gap-2 mt-4 lg:mt-0">
                    <div class="bg-gray-100 rounded-xl p-1 flex gap-1">
                        <button onclick="changeChartRange(7)" 
                            class="range-btn px-4 py-2 rounded-lg text-sm font-medium transition-all <?php echo e($chartRange == 7 ? 'bg-white shadow-md text-indigo-600' : 'text-gray-600 hover:bg-gray-200'); ?>"
                            data-range="7">
                            7 Hari
                        </button>
                        <button onclick="changeChartRange(30)" 
                            class="range-btn px-4 py-2 rounded-lg text-sm font-medium transition-all <?php echo e($chartRange == 30 ? 'bg-white shadow-md text-indigo-600' : 'text-gray-600 hover:bg-gray-200'); ?>"
                            data-range="30">
                            30 Hari
                        </button>
                        <button onclick="changeChartRange(90)" 
                            class="range-btn px-4 py-2 rounded-lg text-sm font-medium transition-all <?php echo e($chartRange == 90 ? 'bg-white shadow-md text-indigo-600' : 'text-gray-600 hover:bg-gray-200'); ?>"
                            data-range="90">
                            90 Hari
                        </button>
                    </div>
...
<script>
    ...
    let currentRange = <?php echo e($chartRange ?? 7); ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laravel project 3\Toko-Roni-Mobile-App\resources\views/dashboard/logistik.blade.php ENDPATH**/ ?>