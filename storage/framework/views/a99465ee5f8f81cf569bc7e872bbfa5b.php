        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-gray-600">
                            Perbarui informasi kategori "<?php echo e($category->name); ?>"
                        </p>
                    </div>
                </div>
                ...
                <div class="mt-4 flex items-center text-sm text-gray-500">
                    <a href="<?php echo e(route('categories.index')); ?>" class="hover:text-blue-600 transition-colors">
                        <i class="fas fa-tag mr-2"></i>
                        Manajemen Kategori
                    </a>
                    <i class="fas fa-chevron-right mx-2"></i>
                    <span class="text-blue-600 font-medium"><?php echo e($category->name); ?></span>
                    <i class="fas fa-chevron-right mx-2"></i>
                ...
                <div class="mt-4 flex flex-wrap gap-2">
                    ...
                    <span
                        class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium <?php echo e($category->is_active ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
                        <i class="fas <?php echo e($category->is_active ? 'fa-check-circle' : 'fa-times-circle'); ?> mr-1.5"></i>
            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
                ...
                <!-- Form Content -->
                <form action="<?php echo e(route('categories.update', $category)); ?>" method="POST" class="p-6 sm:p-8">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="name" value="<?php echo e(old('name', $category->name)); ?>" required
                                class="pl-10 pr-4 py-3 w-full border border-gray-300 rounded-xl shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 focus:shadow-outline-blue transition-all duration-200 <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                <span id="charCount"
                                    class="text-gray-400 text-sm"><?php echo e(strlen(old('name', $category->name))); ?>/50</span>
                            </div>
                        </div>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="relative">
                            ...
                            <textarea name="description" rows="4"
                                ...
                                placeholder="Tambahkan deskripsi kategori (opsional)" oninput="updateDescCharCount(this.value)"><?php echo e(old('description', $category->description)); ?></textarea>
                            <div class="absolute bottom-3 right-3 text-gray-400 text-sm">
                                <span
                                    id="descCharCount"><?php echo e(strlen(old('description', $category->description))); ?>/500</span>
                            </div>
                        </div>
                        <div class="mt-2 text-sm text-gray-500">
                            ...
                            <label class="inline-flex items-center cursor-pointer">
                                ...
                                <div class="ml-4 flex items-center">
                                    <span class="text-lg font-medium text-gray-900 mr-2" id="statusText">
                                        <?php echo e(old('is_active', $category->is_active) ? 'Aktif' : 'Nonaktif'); ?>

                                    </span>
                                    <span id="statusBadge"
                                        class="px-3 py-1 rounded-full text-sm font-medium <?php echo e(old('is_active', $category->is_active) ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
                                        <i
                                            class="fas <?php echo e(old('is_active', $category->is_active) ? 'fa-check-circle' : 'fa-times-circle'); ?> mr-1"></i>
                                        <?php echo e(old('is_active', $category->is_active) ? 'Aktif' : 'Nonaktif'); ?>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-2 gap-4 pt-4 border-t border-gray-200">
                            <div class="text-center p-4 bg-blue-50 rounded-lg">
                                ...
                                <div class="text-lg font-semibold text-gray-900"><?php echo e($category->products_count ?? 0); ?>
                            ...
                            <div class="text-center p-4 bg-green-50 rounded-lg">
                                ...
                                <div class="text-sm font-semibold text-gray-900">
                                    <?php echo e($category->updated_at->diffForHumans()); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="mt-2">
                                <p class="text-sm text-gray-500">
                                    Apakah Anda yakin ingin menghapus kategori <span
                                        class="font-semibold text-gray-900">"<?php echo e($category->name); ?>"</span>?
                                    <?php if($category->products_count > 0): ?>
                                        <br><br>
                                        <span class="text-red-600 font-medium">
                                            <i class="fas fa-exclamation-circle mr-1"></i>
                                            PERHATIAN: Kategori ini memiliki <?php echo e($category->products_count); ?> produk.
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT3\Toko-Roni-Mobile-App\tokoroni-app\resources\views\categories\edit.blade.php ENDPATH**/ ?>