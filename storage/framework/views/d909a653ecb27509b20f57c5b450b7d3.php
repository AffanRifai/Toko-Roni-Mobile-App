            ...
            <div class="d-flex gap-2">
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="<?php echo e(request()->fullUrlWithQuery(['filter' => 'today'])); ?>">Hari
                                Ini</a></li>
                        <li><a class="dropdown-item" href="<?php echo e(request()->fullUrlWithQuery(['filter' => 'week'])); ?>">Minggu
                                Ini</a></li>
                        <li><a class="dropdown-item" href="<?php echo e(request()->fullUrlWithQuery(['filter' => 'month'])); ?>">Bulan
                                Ini</a></li>
                        <li><a class="dropdown-item" href="<?php echo e(request()->fullUrlWithQuery(['filter' => 'all'])); ?>">Semua</a>
                        </li>
                    </ul>
                </div>
                    ...
                    <div class="card-body p-3 p-md-4">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <h4 class="fw-bold mb-0"><?php echo e($transactions->total()); ?></h4>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body p-3 p-md-4">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <h4 class="fw-bold mb-0">Rp <?php echo e(number_format($totalRevenue, 0, ',', '.')); ?></h4>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body p-3 p-md-4">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <h4 class="fw-bold mb-0">Rp <?php echo e(number_format($averageTransaction, 0, ',', '.')); ?></h4>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body p-3 p-md-4">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <h4 class="fw-bold mb-0"><?php echo e($todayTransactions); ?></h4>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="table table-hover align-middle mb-0" id="transactionsTable">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="transaction-row" data-invoice="<?php echo e($t->invoice_number); ?>"
                                    data-cashier="<?php echo e(strtolower($t->user->name ?? '')); ?>"
                                    data-date="<?php echo e($t->created_at->format('Y-m-d')); ?>" data-status="<?php echo e($t->status); ?>"
                                    onclick="window.location.href='<?php echo e(route('transactions.show', $t)); ?>'"
                                    style="cursor: pointer;">
                                    <td class="ps-4">
                                        <span
                                            class="text-muted"><?php echo e(($transactions->currentPage() - 1) * $transactions->perPage() + $loop->iteration); ?></span>
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <div class="fw-semibold"><?php echo e($t->invoice_number); ?></div>
                                                <small class="text-muted">ID: <?php echo e($t->id); ?></small>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex flex-column">
                                            <span class="fw-medium"><?php echo e($t->created_at->format('d M Y')); ?></span>
                                            <small class="text-muted"><?php echo e($t->created_at->format('H:i')); ?></small>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <span class="fw-medium"><?php echo e($t->user->name ?? '-'); ?></span>
                                        </div>
                                    </td>
                                    <td class="text-center">
                                        ...
                                        ?>
                                        <span
                                            class="badge bg-<?php echo e($statusColors[$t->status] ?? 'secondary'); ?>-subtle
                                           text-<?php echo e($statusColors[$t->status] ?? 'secondary'); ?>

                                           border border-<?php echo e($statusColors[$t->status] ?? 'secondary'); ?>-subtle
                                           py-2 px-3">
                                            <i class="fas fa-<?php echo e($statusIcons[$t->status] ?? 'circle'); ?> me-1"></i>
                                    ...
                                    <td class="text-center">
                                        ...
                                        ?>
                                        <span
                                            class="badge bg-<?php echo e($paymentColors[$t->payment_method] ?? 'secondary'); ?>-subtle
                                           text-<?php echo e($paymentColors[$t->payment_method] ?? 'secondary'); ?>

                                           border border-<?php echo e($paymentColors[$t->payment_method] ?? 'secondary'); ?>-subtle
                                           py-1 px-2">
                                            <i
                                                class="fas fa-<?php echo e($paymentIcons[$t->payment_method] ?? 'credit-card'); ?> me-1"></i>
                                            <?php echo e(ucfirst(str_replace('_', ' ', $t->payment_method))); ?>

                                        </span>
                                         <?php if($t->payment_method === 'credit_card'): ?>
                                    ...
                                    <td class="text-end pe-4">
                                        <div class="d-flex flex-column align-items-end">
                                            <span class="fw-bold fs-5">Rp
                                                <?php echo e(number_format($t->total_amount, 0, ',', '.')); ?></span>
                                            <small class="text-muted"><?php echo e($t->items->count()); ?> item</small>
                                        </div>
                                    </td>
                                </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT3\Toko-Roni-Mobile-App\tokoroni-app\resources\views\transactions\history.blade.php ENDPATH**/ ?>