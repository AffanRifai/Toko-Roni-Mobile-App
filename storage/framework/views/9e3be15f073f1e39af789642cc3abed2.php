...
unset($__errorArgs, $__bag); ?>">
                                ...
                                <option value="motorcycle" <?php echo e(old('type') == 'motorcycle' ? 'selected' : ''); ?>>Motor</option>
                                <option value="pickup" <?php echo e(old('type') == 'pickup' ? 'selected' : ''); ?>>Pickup</option>
                            </select>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Toko-Roni-Mobile-App\resources\views/vehicles/create.blade.php ENDPATH**/ ?>